...
class CreateSmLanguagePhrasesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $d = [
            ...
            [20, 'contact_message', 'Contact Message', 'Contact Message', 'বার্তা পৃষ্ঠা', 'Contact Message'],
            ...
            [20, 'chat_box', 'Chat Box', 'Chat Box', 'চ্যাট বক্স', 'Chat Box'],
            [20, 'blocked_user', 'Blocked User', 'Blocked User', 'অবরুদ্ধ ব্যবহারকারী', 'Blocked User'],
            [20, 'chat_settings', 'Chat Settings', 'Chat Settings', 'চ্যাট সেটিংস', 'Chat Settings'],
