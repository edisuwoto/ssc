...
Route::group(['middleware' => ['XSS','auth:api','json.response']], function () {
    ...
    Route::get('school/{school_id}/student-attendance', ['as' => 'student_attendance', 'uses' => 'api\ApiSmStudentAttendanceController@saas_student_attendance_index']);
    ...
    Route::get('school/{school_id}/student-attendance-report', ['as' => 'student_attendance_report', 'uses' => 'api\ApiSmStudentAttendanceController@saas_studentAttendanceReport']);
    ...
    Route::post('school/{school_id}/student-attendance-report-search', ['as' => 'student_attendance_report_search', 'uses' => 'api\ApiSmStudentAttendanceController@saas_studentAttendanceReportSearch']);
    ...
    //homework list
    Route::get('homework-list/{user_id}', ['as' => 'homework-list', 'uses' => 'api\ApiSmHomeWorkController@homeworkList']);
    Route::get('school/{school_id}/homework-list', ['as' => 'homework-list', 'uses' => 'api\ApiSmHomeWorkController@saas_homeworkList']);
    Route::post('homework-list', ['as' => 'homework-list', 'uses' => 'api\ApiSmHomeWorkControllerr@searchHomework']);
    ...
    Route::get('school/{school_id}/homework-list/{id}', 'api\ApiSmHomeWorkController@saas_homework_List');
    //--------------- End Homework Module--------------
