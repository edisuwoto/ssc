...
Route::get('/testpayment','HomeController@testpayment');
...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::get('view-leave-details-apply/{id}', 'SmLeaveRequestController@viewLeaveDetails')->name('view-leave-details-apply');
    Route::get('clear-cache','SmSystemSettingController@CacheClear');
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::get('/user-language-change', 'SmSystemSettingController@ajaxUserLanguageChange');
