...
<?php echo app('translator')->get('lang.fees_forward'); ?>
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.fees_forward'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.fees_collection'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.fees_forward'); ?></a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"><?php echo app('translator')->get('lang.previous_Session_Balance_Fees'); ?></h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <div class="alert">
                                            <h4 class="mb-0"> <?php echo app('translator')->get('lang.previous_balance_can_only_update_now.'); ?> </h4>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php endif; ?>
                                    <tr>
                                        ...
                                        <th width="15%"><?php echo app('translator')->get('lang.roll'); ?> <?php echo app('translator')->get('lang.no'); ?></th>
                                        <th width="15%"><?php echo app('translator')->get('lang.father_name'); ?></th>
                                        <th width="15%"><?php echo app('translator')->get('lang.balance'); ?> (<?php echo e(generalSetting()->currency_symbol); ?>)</th>
                                        <th width="25%"><?php echo app('translator')->get('lang.short'); ?> <?php echo app('translator')->get('lang.note'); ?></th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-effect">
                                                <input oninput="numberCheckWithDot(this)" type="text" class="primary-input form-control" cols="0" rows="1" name="balance[<?php echo e(isset($update)? $student->forwardBalance->id:$student->id); ?>]" maxlength="8" value="<?php echo e(isset($update)?
                                                $student->forwardBalance->balance: ''); ?>">
                                                <label><?php echo app('translator')->get('lang.balance'); ?> <span></span></label>
                                        ...
                                        <td>
                                            <div class="input-effect">
                                                <input type="text" class="primary-input form-control" cols="0" rows="1" name="notes[<?php echo e(isset($update)? $student->forwardBalance->id:$student->id); ?>]" value="<?php echo e(isset($update)?
                                                $student->forwardBalance->notes: 'Fees Carry Forward'); ?>">
                                                <label><?php echo app('translator')->get('lang.short'); ?> <?php echo app('translator')->get('lang.note'); ?><span></span></label>
                                                <span class="focus-border"></span>
                                                <span class="invalid-feedback">
                                                    <strong><?php echo app('translator')->get('lang.error'); ?></strong>
                                                </span>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/feesCollection/fees_forward.blade.php ENDPATH**/ ?>