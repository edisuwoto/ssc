...
<?php echo app('translator')->get('lang.payroll_report'); ?>
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.payroll_report'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.human_resource'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.payroll_report'); ?></a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="main-title">
                            ...
                            <div class="col-lg-12">
                                <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->get('lang.month'); ?> - <?php echo app('translator')->get('lang.year'); ?></th>
                                        <th><?php echo app('translator')->get('lang.payslip'); ?> #</th>
                                        <th><?php echo app('translator')->get('lang.basic_salary'); ?>(<?php echo e(generalSetting()->currency_symbol); ?>)</th>
                                        <th><?php echo app('translator')->get('lang.earnings'); ?>(<?php echo e(generalSetting()->currency_symbol); ?>)</th>
                                        <th><?php echo app('translator')->get('lang.deductions'); ?>(<?php echo e(generalSetting()->currency_symbol); ?>)</th>
                                        <th><?php echo app('translator')->get('lang.leave'); ?> <?php echo app('translator')->get('lang.deductions'); ?>(<?php echo e(generalSetting()->currency_symbol); ?>)</th>
                                        <th><?php echo app('translator')->get('lang.gross_salary'); ?>(<?php echo e(generalSetting()->currency_symbol); ?>)</th>
                                        <th><?php echo app('translator')->get('lang.tax'); ?>(<?php echo e(generalSetting()->currency_symbol); ?>)</th>
                                        <th><?php echo app('translator')->get('lang.net_salary'); ?>(<?php echo e(generalSetting()->currency_symbol); ?>)</th>
                                    </tr>
                                    </thead>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo e(generalSetting()->currency_symbol); ?><?php echo e($basic_salary); ?></th>
                                        <th><?php echo e(generalSetting()->currency_symbol); ?><?php echo e($earnings); ?></th>
                                        <th><?php echo e(generalSetting()->currency_symbol); ?><?php echo e($deductions); ?></th>
                                        <th><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(@$leaveDeductions->salary_deduct); ?></th>
                                        <th><?php echo e(generalSetting()->currency_symbol); ?><?php echo e($gross_salary); ?></th>
                                        <th><?php echo e(generalSetting()->currency_symbol); ?><?php echo e($tax); ?></th>
                                        <th><?php echo e(generalSetting()->currency_symbol); ?><?php echo e($net_salary); ?></th>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/reports/payroll.blade.php ENDPATH**/ ?>