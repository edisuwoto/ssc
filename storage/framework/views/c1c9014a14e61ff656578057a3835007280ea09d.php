...
<?php echo app('translator')->get('lang.role_permission'); ?>
            ...
            <div id="Role<?php echo e($module_info->id); ?>" class="collapse">
                <div  class="permission_body">
                    ...
                    <?php
                                                ...
                                                $subModule= DB::table('infix_module_infos')->where('parent_id',$module_info->id)->whereNotIn('id',[399,400,401,402,403,404,428,429,430,431,456,457,458,459,460,461,462,463,478,482,483,484,549])->where('active_status', 1)->get();

                                                }else{
                                                $subModule= DB::table('infix_module_infos')->where('parent_id',$module_info->id)->whereNotIn('id',[833,834,193])->where('active_status', 1)->get();
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/modules/rolepermission/role_permission.blade.php ENDPATH**/ ?>