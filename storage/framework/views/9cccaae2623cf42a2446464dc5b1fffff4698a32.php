...
<?php echo app('translator')->get('lang.student_certificate'); ?>
...
<section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.student_certificate'); ?></h1>
            <div class="bc-pages">
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row no-gutters input-right-icon mt-35">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e($errors->has('file') ? ' is-invalid' : ''); ?>" id="placeholderInput" type="text" placeholder="<?php echo e(isset($certificate)? ($certificate->file != ""? getFilePath3($certificate->file):trans('lang.image') .' *'): trans('lang.image') .' (1100 X 850)px *'); ?>" readonly>
                                            <span class="focus-border"></span>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(route('student-certificate-edit',@$certificate->id)); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/admin/student_certificate.blade.php ENDPATH**/ ?>