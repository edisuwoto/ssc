...
<?php echo app('translator')->get('lang.marks_register'); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="exam_setup_ids[]" value="<?php echo e(@$part->id); ?>">
                                    ...
                                    <input oninput="numberCheckWithDot(this)" class="primary-input marks_input" type="text" name="marks[<?php echo e(@$student->id); ?>][<?php echo e(@$part->id); ?>]" value="0" max="100">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/examination/masks_register.blade.php ENDPATH**/ ?>