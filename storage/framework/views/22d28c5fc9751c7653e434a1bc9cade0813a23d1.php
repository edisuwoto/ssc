    ...
    <section class="academics-area section-gap-top">
        <div class="container">
            ...
            <div class="row text-center mt-30">
                <div class="col-lg-12">
                    <a class="primary-btn fix-gr-bg semi-large load_more_btn" href="javascript::void(0)"><?php echo app('translator')->get('lang.load_more_courses'); ?></a>
                </div>
            </div>
        </div>
    </section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/frontEnd/home/light_course.blade.php ENDPATH**/ ?>