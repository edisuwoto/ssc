...
<body class="admin" style=" <?php if(@activeStyle()->id==1): ?> <?php echo e($css); ?> <?php else: ?> background:<?php echo e(@activeStyle()->dashboardbackground); ?> !important; <?php endif; ?> ">
    ...
    <div class="main-wrapper" style="min-height: 600px">
        ...
        <div id="main-content">
         ...
         <?php echo $__env->make('backEnd.partials.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ssc/resources/views/backEnd/partials/header.blade.php ENDPATH**/ ?>