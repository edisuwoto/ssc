...
<?php echo app('translator')->get('lang.add_book'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mainContent'); ?>
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('lang.add_book'); ?></h1>
                <div class="bc-pages">
                    <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                    <a href="#"><?php echo app('translator')->get('lang.library'); ?></a>
                    <?php if(isset($editData)): ?>
                        <a href="#"><?php echo app('translator')->get('lang.edit_book'); ?></a>
                    <?php else: ?>
                        <a href="#"><?php echo app('translator')->get('lang.add_book'); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="main-title ">
                        <h3 class="mb-30">
                            ...
                            <?php endif; ?>
                            <?php echo app('translator')->get('lang.book'); ?></h3>
                    </div>
                </div>
            </div>
            <?php if(isset($editData)): ?>
                            ...
                            <div class="row mb-30">
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label><?php echo app('translator')->get('lang.book_title'); ?> <span>*</span> </label>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        <select
                                            ...
                                            <option data-display="<?php echo app('translator')->get('lang.select_book_category'); ?> *"
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label><?php echo app('translator')->get('lang.book'); ?> <?php echo app('translator')->get('lang.no'); ?></label>
                                        <span class="focus-border"></span>
                            ...
                            <div class="row mb-30">
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label><?php echo app('translator')->get('lang.isbn'); ?> <?php echo app('translator')->get('lang.no'); ?></label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label><?php echo app('translator')->get('lang.publisher'); ?> <?php echo app('translator')->get('lang.name'); ?></label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label><?php echo app('translator')->get('lang.author_name'); ?></label>
                                        <span class="focus-border"></span>
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label><?php echo app('translator')->get('lang.rack'); ?> <?php echo app('translator')->get('lang.number'); ?></label>
                                        <span class="focus-border"></span>
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label><?php echo app('translator')->get('lang.quantity'); ?></label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label><?php echo app('translator')->get('lang.book_price'); ?></label>
                                        <span class="focus-border"></span>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12 text-center">
                                <button class="primary-btn fix-gr-bg submit" data-toggle="tooltip" title="<?php echo e($tooltip); ?>">
                                    ...
                                    <?php echo app('translator')->get('lang.book'); ?>
                                </button>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/ssc/resources/views/backEnd/library/addBook.blade.php ENDPATH**/ ?>