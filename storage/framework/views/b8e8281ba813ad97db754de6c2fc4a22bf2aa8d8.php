    ...
    <section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('lang.complaint'); ?></h1>
                <div class="bc-pages">
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input" id="placeholderInput" type="text"
                                                       placeholder="<?php echo e(isset($complaint)? ($complaint->file != ""? getFilePath3($complaint->file):trans('lang.file')):trans('lang.file')); ?>"
                                                       readonly>
                                                <span class="focus-border"></span>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/admin/complaint.blade.php ENDPATH**/ ?>