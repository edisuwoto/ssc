            ...
            <div class="row">
                ...
                <?php if(isset($per["Notice Board"])): ?>
                    <div class="col-lg-3 notice-board-area">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="title"><?php echo app('translator')->get('lang.notice_board'); ?></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row mb-40">
                            <div class="col-lg-6 col-md-7">
                                <h3 class="title"><?php echo app('translator')->get('lang.event_ist'); ?></h3>
                            </div>
                            <div class="col-lg-6 col-md-5 text-md-right text-left mb-30-lg">
                                <a href="#" class="primary-btn small fix-gr-bg"><?php echo app('translator')->get('lang.browse_all'); ?></a>
                            </div>
                        </div>
                        <div class="row">
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/frontEnd/home/light_home.blade.php ENDPATH**/ ?>