...
<?php echo app('translator')->get('lang.add_expense'); ?>
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php else: ?>
                        <?php if(userPermission(144)): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'add-expense',
                                ...
                                <div class="row mt-25">
                                     <div class="col">
                                        <div class="row no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input" type="text" id="placeholderFileOneName" placeholder="<?php echo e(isset($add_expense)? ($add_expense->file != ""? getFilePath3($add_expense->file): trans('lang.file')) :  trans('lang.file')); ?>"readonly
                                                        >
                                                    <span class="focus-border"></span>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-sort="<?php echo e(strtotime(@$add_expense->date)); ?>">
                                        <?php echo e(@$add_expense->date != ""? dateConvert(@$add_expense->date):''); ?></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <?php if(userPermission(145)): ?>

                                                <a class="dropdown-item" href="<?php echo e(route('add-expense-edit', [@$add_expense->id])); ?>"><?php echo app('translator')->get('lang.edit'); ?> </a>
                                                <?php endif; ?>
                                                <?php if(userPermission(146)): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if($add_expense->file != ""): ?>
                                                    <a class="dropdown-item" href="<?php echo e(url(@$add_expense->file)); ?>" download>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal"><?php echo app('translator')->get('lang.cancel'); ?> </button>
                                                     <?php echo e(Form::open(['route' => array('add-expense-delete',@$add_expense->id), 'method' => 'DELETE', 'enctype' => 'multipart/form-data'])); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/accounts/add_expense.blade.php ENDPATH**/ ?>