...
<?php echo app('translator')->get('lang.add_member'); ?>
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.add_member'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.library'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.add_member'); ?></a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30"><?php if(isset($editData)): ?>
                                ...
                                <?php else: ?>
                                    <?php echo app('translator')->get('lang.add'); ?>
                                <?php endif; ?>
                                <?php echo app('translator')->get('lang.member'); ?>
                            </h3>
                        </div>
                        <?php if(isset($editData)): ?>
                        ...
                        <?php else: ?>
                        <?php if(userPermission(309) ): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'library-member',
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-30">
                                        <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('member_type') ? ' is-invalid' : ''); ?>" name="member_type" id="member_type">
                                            ...
                                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(isset($editData)): ?>
                                                    <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $editData->role_id? 'selected':''); ?>><?php echo e($value->full_name); ?></option>
                                                <?php else: ?>
                                    ...
                                    <div class="col-lg-12 mb-30">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.member'); ?> <?php echo app('translator')->get('lang.id'); ?> <span>*</span> </label>
                                            <span class="focus-border"></span>
                                            <?php if($errors->has('member_ud_id')): ?>
                                                <span class="invalid-feedback" role="alert">
                                                    <strong><?php echo e($errors->first('member_ud_id')); ?></strong>
                                                </span>
                                            <?php endif; ?>
                                        </div>
            ...
            <div class="col-lg-9">
              <div class="row">
                <div class="col-lg-4 no-gutters">
                    <div class="main-title">
                        <h3 class="mb-0"><?php echo app('translator')->get('lang.member'); ?> <?php echo app('translator')->get('lang.list'); ?></h3>
                    </div>
                </div>
            </div>
                    ...
                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('lang.member_type'); ?></th>
                                <th><?php echo app('translator')->get('lang.member'); ?> <?php echo app('translator')->get('lang.id'); ?></th>
                        ...
                        <td>
                        <?php if(userPermission(310)): ?>
                            <a class="primary-btn fix-gr-bg nowrap" href="<?php echo e(route('cancel-membership',@$value->id)); ?>"><?php echo app('translator')->get('lang.cancel'); ?> <?php echo app('translator')->get('lang.membership'); ?></a>
                        <?php endif; ?>
                        </td>
                    </tr>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/ssc/resources/views/backEnd/library/members.blade.php ENDPATH**/ ?>