...
<section class="student-attendance">
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-6 no-gutters">
                <a href="<?php echo e(route('student-attendance-print', [$class_id, $section_id, $month, $year])); ?>" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i><?php echo app('translator')->get('lang.print'); ?></a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/studentInformation/student_attendance_report.blade.php ENDPATH**/ ?>