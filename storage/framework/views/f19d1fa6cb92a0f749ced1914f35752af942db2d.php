...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.student'); ?> <?php echo app('translator')->get('lang.registration'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.custom'); ?> <?php echo app('translator')->get('lang.field'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.student'); ?> <?php echo app('translator')->get('lang.registration'); ?></a>
            </div>
        </div>
    </div>
</section>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <?php if(userPermission(1103)): ?>
                                                        <a class="dropdown-item" href="<?php echo e(route('edit-custom-field',['id' => @$custom_field->id])); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/customField/studentRegistration.blade.php ENDPATH**/ ?>