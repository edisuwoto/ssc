...
<?php $__env->startSection('title'); ?> 
    <?php echo app('translator')->get('lang.postal_receive'); ?>
...
<section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.postal_receive'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.admin_section'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.postal_receive'); ?></a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php else: ?>
                         <?php if(userPermission(28) || Auth::user()->role_id == 1): ?>
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'postal-receive',
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.from_title'); ?><span>*</span></label>
                                ...
                                <div class="row no-gutters input-right-icon mt-35">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input" id="placeholderInput" type="text" placeholder="<?php echo e(isset($postal_receive)? ($postal_receive->file != ""? getFilePath3($postal_receive->file):trans('lang.file')):trans('lang.file')); ?>" readonly>
                                            <span class="focus-border"></span>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->get('lang.postal_receive'); ?> <?php echo app('translator')->get('lang.list'); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  data-sort="<?php echo e(strtotime(@$postal_receive->date)); ?>" ><?php echo e(!empty($postal_receive->date)? dateConvert(@$postal_receive->date):''); ?> </td>
                                    <td>
                                        <div class="dropdown">
                                               ...
                                               <a class="dropdown-item" data-toggle="modal" data-target="#deletePostalReceiveModal<?php echo e(@$postal_receive->id); ?>"
                                                ...
                                                <?php endif; ?>
                                                  ...
                                                  <?php if(userPermission(31)): ?>
                                                    <?php if(@file_exists($postal_receive->file)): ?>
                                                        <a class="dropdown-item" href="<?php echo e(url(@$postal_receive->file)); ?>" download>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"><?php echo app('translator')->get('lang.delete'); ?> <?php echo app('translator')->get('lang.postal_receive'); ?></h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/admin/postal_receive.blade.php ENDPATH**/ ?>