...
<?php echo app('translator')->get('lang.issue_item'); ?> <?php echo app('translator')->get('lang.list'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mainContent'); ?>
<section class="sms-breadcrumb mb-40 white-box">
  <div class="container-fluid">
    <div class="row justify-content-between">
      <h1><?php echo app('translator')->get('lang.issue_item'); ?> <?php echo app('translator')->get('lang.list'); ?></h1>
      <div class="bc-pages">
        <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
        <a href="#"><?php echo app('translator')->get('lang.inventory'); ?></a>
        <a href="#"><?php echo app('translator')->get('lang.issue_item'); ?> <?php echo app('translator')->get('lang.list'); ?></a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="main-title">
              <h3 class="mb-30">
                  <?php echo app('translator')->get('lang.issue_a_item'); ?>
              </h3>
            </div>
            <?php if(isset($editData)): ?>
            <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => array('holiday-update',$editData->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data'])); ?>

            <?php else: ?>
             <?php if(userPermission(346)): ?>
            <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'save-item-issue-data',
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 mb-30">
                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('role_id') ? ' is-invalid' : ''); ?>" name="role_id" id="member_type">
                      <option data-display=" <?php echo app('translator')->get('lang.user_type'); ?> *" value=""><?php echo app('translator')->get('lang.user_type'); ?> *</option>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12 mb-30" id="select_student_div">
                        <select class="w-100 bb niceSelect form-control<?php echo e($errors->has('student') ? ' is-invalid' : ''); ?>" id="select_student" name="student">
                          <option data-display="<?php echo app('translator')->get('lang.select_student'); ?>*" value=""><?php echo app('translator')->get('lang.select_student_for_issue'); ?> *</option>
                        </select>
                  ...
                  <div class="col-lg-12 mb-30" id="selectStaffsDiv">
                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('staff_id') ? ' is-invalid' : ''); ?>" name="staff_id" id="selectStaffs">
                      <option data-display="<?php echo app('translator')->get('lang.issue_to'); ?>" value=""><?php echo app('translator')->get('lang.issue_to'); ?></option>
                ...
                <div class="row no-gutters input-right-icon mb-30 w-100">
                  ...
                  <div class="col">
                    <div class="input-effect">
                      ...
                      <label><?php echo app('translator')->get('lang.issue_date'); ?> <span></span> </label>
                ...
                <div class="row no-gutters input-right-icon mb-30 w-100">
                  ...
                  <div class="col">
                    <div class="input-effect">
                      ...
                      <label><?php echo app('translator')->get('lang.return_date'); ?> <span></span> </label>
                      <span class="focus-border"></span>
                ...
                <div class="row">
                  <div class="col-lg-12 mb-30">
                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('item_category_id') ? ' is-invalid' : ''); ?>" name="item_category_id" id="item_category_id">
                      <option data-display="<?php echo app('translator')->get('lang.item_category'); ?> *" value=""><?php echo app('translator')->get('lang.item_category'); ?> *</option>
                  ...
                  <div class="col-lg-12 mb-30" id="selectItemsDiv">
                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('item_id') ? ' is-invalid' : ''); ?>" name="item_id" id="selectItems">
                      <option data-display="<?php echo app('translator')->get('lang.item'); ?><?php echo app('translator')->get('lang.name'); ?> *" value=""><?php echo app('translator')->get('lang.item'); ?><?php echo app('translator')->get('lang.name'); ?> *</option>
                    </select>
                  ...
                  <div class="col-lg-12 mb-30">
                    <div class="input-effect">
                      ...
                      type="text" onkeypress="return isNumberKey(event)" name="quantity" autocomplete="off" value="<?php echo e(old('quantity')); ?>">
                      <label><?php echo app('translator')->get('lang.quantity'); ?> <span>*</span> </label>
                      <span class="focus-border"></span>
      ...
      <div class="row">
        <div class="col-lg-4 no-gutters">
          <div class="main-title">
            <h3 class="mb-0"> <?php echo app('translator')->get('lang.issued_item_list'); ?></h3>
          </div>
        </div>
      </div>
          ...
          <table id="table_id" class="display school-table" cellspacing="0" width="100%">
            <thead>
              <tr>
                ...
                <th> <?php echo app('translator')->get('lang.item'); ?>  <?php echo app('translator')->get('lang.category'); ?></th>
                <th> <?php echo app('translator')->get('lang.issue_to'); ?></th>
              ...
              <tr>
                ...
                <td> <?php if(!empty($getMemberDetail)): ?>
                  ...
                  <td> 
                     ...
                     <button class="primary-btn small bg-success text-white border-0"> <?php echo app('translator')->get('lang.issued'); ?></button>
                     <?php else: ?>
                      <button class="primary-btn small bg-primary text-white border-0"><?php echo app('translator')->get('lang.returned'); ?></button>
                     <?php endif; ?>
                  </td>
                   ...
                   <?php if($value->issue_status == 'I'): ?>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <?php if(userPermission(347)): ?>
                       <a class="dropdown-item modalLink" title="Return Item" data-modal-size="modal-md" href="<?php echo e(route('return-item-view',@$value->id)); ?>"><?php echo app('translator')->get('lang.return'); ?></a>
                       <?php endif; ?>
                    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/ssc/resources/views/backEnd/inventory/issueItemList.blade.php ENDPATH**/ ?>