													 ...
													 $chars = preg_split('/[\s,]+/', $body, -1, PREG_SPLIT_NO_EMPTY | PREG_SPLIT_DELIM_CAPTURE);
													    ...
													    foreach($chars as $item){
													        if(strstr($item[0],"[")){
													            ...
													            $custom_array[$item]= App\SmsTemplate::getValueByStringTestRegistration($compact, $str);
													        } 
...
</html><?php /**PATH /Users/edisuwoto/Documents/webdev/ssc/resources/views/modules/parentregistration/new_reg_email.blade.php ENDPATH**/ ?>