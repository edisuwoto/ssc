...
<?php echo app('translator')->get('lang.add_new_staff'); ?>
              ...
              <div class="white-box">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('branch_id') ? ' is-invalid' : ''); ?>" name="branch_id" id="branch_id">
                                         <option data-display="<?php echo app('translator')->get('lang.branch'); ?> *" value=""><?php echo app('translator')->get('lang.branch'); ?> *</option>
                        ...
                        <div class="col-lg-3">
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('designation_id') ? ' is-invalid' : ''); ?>" name="designation_id" id="designation_id">
                                    <option data-display="<?php echo app('translator')->get('lang.designations'); ?> *" value=""><?php echo app('translator')->get('lang.select'); ?> </option>
                ...
                <div class="col-lg-3">
                    <div class="input-effect">
                        ...
                        <span class="focus-border"></span>
                        <label><?php echo app('translator')->get('lang.emergency_mobile'); ?> <span></span></label>
                    ...
                    <div class="row no-gutters input-right-icon">
                        <div class="col">
                            <div class="input-effect">
                                ...
                                placeholder="<?php echo e(isset($editData->file) && $editData->file != '' ? getFilePath3($editData->file):trans('lang.staff') . trans('lang.photo').'  '); ?>"
                                disabled>
                                <span class="focus-border"></span>
...
<div class="row mb-20">
   <div class="col-lg-4">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderResume" placeholder="<?php echo e(isset($editData->resume) && $editData->resume != ""? getFilePath3($editData->resume):trans('lang.resume')); ?>"
                readonly>
                <span class="focus-border"></span>
            </div>
        </div>
...
<div class="col-lg-4">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderJoiningLetter" placeholder="<?php echo e(isset($editData->joining_letter) && $editData->joining_letter != ""? getFilePath3($editData->joining_letter):trans('lang.joining_letter')); ?>"
                readonly>
                <span class="focus-border"></span>
            </div>
        </div>
...
<div class="col-lg-4">
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderOthersDocument" placeholder="<?php echo e(isset($editData->other_document) && $editData->other_document != ""? getFilePath3($editData->other_document):trans('lang.other') . trans('lang.documents')); ?>"
                readonly>
                <span class="focus-border"></span>
            </div>
        </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/humanResource/addStaff.blade.php ENDPATH**/ ?>