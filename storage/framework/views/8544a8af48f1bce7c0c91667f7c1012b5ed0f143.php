...
<?php echo app('translator')->get('lang.transport_route'); ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e($errors->has('far') ? ' is-invalid' : ''); ?>"
                                                type="number" step="0.1" name="far" autocomplete="off" value="<?php echo e(isset($route)? @$route->far:old('far')); ?>">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/transport/route.blade.php ENDPATH**/ ?>