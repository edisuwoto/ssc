...
<?php echo app('translator')->get('lang.language'); ?> <?php echo app('translator')->get('lang.settings'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('mainContent'); ?>
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.language'); ?> <?php echo app('translator')->get('lang.settings'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
                <a href="#"><?php echo app('translator')->get('lang.system'); ?> <?php echo app('translator')->get('lang.settings'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.language'); ?> <?php echo app('translator')->get('lang.settings'); ?></a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-30">
                            <?php echo app('translator')->get('lang.language_setup'); ?></h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 mb-30">
                        <div class="white-box onchangeSearch">
                            <select class="w-100 bb niceSelect form-control <?php echo e($errors->has('module_id') ? ' is-invalid' : ''); ?>" id="module_id" name="module_id">
                                <option data-display="Select Module *" value=""><?php echo app('translator')->get('lang.select'); ?> <?php echo app('translator')->get('lang.module'); ?> *</option>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/ssc/resources/views/backEnd/systemSettings/languageSetup.blade.php ENDPATH**/ ?>