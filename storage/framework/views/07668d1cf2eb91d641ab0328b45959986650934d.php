...
<?php echo app('translator')->get('lang.Send_Email_Sms'); ?>
    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="#"> <?php echo app('translator')->get('lang.Send_Email_Sms'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('lang.Send_Email_Sms'); ?> </h3>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="d-flex radio-btn-flex ml-40">
                                                    ...
                                                    <div class="mr-30">
                                                        ...
                                                        <label for="Sms"><?php echo app('translator')->get('lang.sms'); ?></label>
                                                    </div>
                        ...
                        <div class="row student-details mt_0_sm">
                            ...
                            <div class="col-lg-12">
                                <ul class="nav nav-tabs mt_0_sm mb-20" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" selectTab="C" href="#class_section_email_sms" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.class'); ?></a>
                                    </li>
                ...
                <div class="alert alert-warning mt-30">
                    <?php echo app('translator')->get('lang.For_Sending_Email'); ?>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                </div>
                 <?php if(userPermission(292)): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/edisuwoto/Documents/webdev/uint/resources/views/backEnd/communicate/sendEmailSms.blade.php ENDPATH**/ ?>