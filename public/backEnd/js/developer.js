(function($) {
    ...
    addRowMark = () => {
        ...
        newRow +=
            "<input class='primary-input form-control' type='text' placeholder='" + lang + "' id='exam_title' name='exam_title[]' autocomplete='off'>";
...
$(document).ready(function() {
    $("#sPagesCheckbox").click(function() {
        if ($("#sPagesCheckbox").is(":checked")) {
            //select all
            $("#sPages").find("option").prop("selected", true);
...
function numberMinZeroCheck(value) {
    let val = $(value).val();
    var patt = new RegExp(/^(?!1+$)[.0-9]{0,51}$/);
    var res = patt.test(val);
    var el = $(value).parent();
    if (!res) {
...
addRowLesson = () => {
    ...
    newRow += "<div class='input-effect'>";
    newRow +=
        "<input class='primary-input form-control' required type='text'  placeholder='" + lang + " *'  id='lesson' name='lesson[]' autocomplete='off'>";
...
addRowTopic = () => {
    ...
    newRow += "<div class='input-effect'>";
    newRow +=
        "<input class='primary-input form-control' required type='text'  placeholder='" + lang + " *'  id='topic' name='topic[]' autocomplete='off'>";
