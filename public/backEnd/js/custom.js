(function($) {
    ...
    $(document).on("click", "#create-image-option", function(event) {
        ...
        for (var i = 1; i <= number_of_option; i++) {
            ...
            appendRow += "<div class='col-lg-10'>";
            appendRow += "<div class='input-effect'>";
            // appendRow +="<input class='primary-input form-control has-content'  type='file' name='images[]' autocomplete='off' required>";
    ...
    //         setTimeout(function() {
    //             toastr.error(
    //                 "May duplicate entry occured, please check and try again!",
    //                 "Error Alert", {
    //                     timeOut: 5000,
    //                 }
    //             );
    ...
    $("form#item-sell-form").on("submit", function() {
        ...
        // if ($("#payment_method").val() == "") {
        //     $("#paymentError").html("The payment method field is required111");
        //     $("#accountError").html("");
        // }else if($("#payment_method").val()==3){
        //     $("#payment_method").html("");
        //     if ($("#account_id").val() == "") {
        //         $("#accountError").html("The account field is required");
        //     } else {
        //         $("#accountError").html("");
        //     }
        // }
