...
@section('title')
@lang('lang.menu') @lang('lang.position')
@endsection
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.menu') </h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.menu')</a>
                <a href="#">@lang('lang.menu') @lang('lang.position')</a>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="erp_role_permission_area ">
                            ...
                            <!-- single_permission  -->
                                    @if(count($all_sidebars)>0)
                                            ...
                                            <div  class="mesonary_role_header ttt" >
