...
class MenuManageController extends Controller
{
    ...
    public function index()
    {
        ...
        $role = InfixRole::where('is_saas',0)->where('id',$user->id)->first();
        ...
        if(!in_array($user->role_id,[2,3])){   
            ...
            $infix =  $infix->where('module_id','!=',1)->where('is_saas',0)->where('parent_id',0)->groupBy('module_id')->where('active_status', 1)->get();
