...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.lesson') @lang('lang.plan')</h1>
            <div class="bc-pages">
...
<section class="mt-20">
    <div class="container-fluid p-0">
            ...
            <div class="row mt-40">
                    ...
                    <h3 class="text-center "><a href="{{url('/lesson/dicrease-week/'.$dates[0])}}"><</a> week {{$week_number}} | <span class="yearColor"> {{date('Y', strtotime($dates[0]))}} </span><a href="{{url('/lesson/change-week/'.$dates[6])}}"> > </a></h3> 
                        </div>
                    </div>
             </div>
        <div class="row">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endphp
                                @if($lessonPlan)
                                <span class="tt" style="color: #212529;font-weight: 600;">Lesson : {{@$lessonPlan->lesson_title}}</span></br>
                                <span class="tt" style="color: #212529;font-weight: 600;">Topic : {{@$lessonPlan->topic_title}}</span></br>
