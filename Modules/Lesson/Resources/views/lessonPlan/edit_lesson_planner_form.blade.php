        ...
        <div class="row">
            <div class="col-lg-12">  
                ...
                <div class="row mt-25">
                    ...
                    <div class="col-lg-4" >
                       <select class="w-100 bb niceSelect form-control{{ $errors->has('section') ? ' is-invalid' : '' }} select_lesson" id="select_lesson" onchange="changeLesson()" name="lesson">
                        <option data-display="@lang('lang.select_lessons') *" value="">@lang('lang.lesson') *</option>
                    ...
                    <div class="col-lg-4" id="select_topic_div">
                        ...
                        <select class="w-100 bb niceSelect form-control{{ $errors->has('section') ? ' is-invalid' : '' }} select_topic" id="select_topic" name="topic">
                            <option data-display="@lang('lang.select_topics') *" value=""> @lang('lang.topic')*</option>
                        ...
                        <div class="col-lg-4 mt-30-md">
                            <div class="input-effect">
                                ...
                                <label id="teacher_label">@lang('lang.sub') @lang('lang.topic')</label>
              ...
              <div class="mt-40 d-flex justify-content-between">
                    ...
                    <button class="primary-btn fix-gr-bg" type="submit">@lang('lang.update') @lang('lang.information')</button>
                </div>
