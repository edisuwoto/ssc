...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.add') @lang('lang.lesson')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.lesson') @lang('lang.plan')</a>
                <a href="#">@lang('lang.edit') @lang('lang.lesson')</a>
            </div>
        </div>
    </div>
</section>
...
{{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'lesson-update', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                ...
                                <div class="row ">
                                     <div class="col-lg-12">
                                       ...
                                       <select class="w-100 bb niceSelect form-control {{ $errors->has('class') ? ' is-invalid' : '' }}" id="select_class" name="class" disabled="">
                                        <option data-display="@lang('lang.select_class') *" value="">@lang('lang.class') *</option>
                                 ...
                                 <input type="hidden" name="class" value="{{ $lesson->class_id }}">
                                ...
                                <div class="row mt-25">
                                        ...
                                        <div class="col-lg-12" id="select_section_div">
                                           ...
                                           <select class="w-100 bb niceSelect form-control{{ $errors->has('section') ? ' is-invalid' : '' }} select_section" id="select_section" name="section" disabled="">
                                                <option data-display="@lang('lang.select_section') *" value="">@lang('lang.select_section') *</option>                     @foreach($sections as $section)
                    ...
                    <div class="col-lg-12">
                        <div class="white-box mt-10">
                            <div class="row">
                                    <div class="col-lg-10">
                                       <div class="main-title">
                                           <h5>@lang('lang.add') @lang('lang.lesson') @lang('lang.name')</h5>
                                       </div>
                                   </div>
                                   <div class="col-lg-2">
                            ...
                            <table class="" id="productTable">
                                ...
                                <tbody>
                                  ...
                                  <tr id="row1" >
                                    ...
                                    <td class="pt-2">
                                      <a href="" data-toggle="modal" data-target="#deleteLessonTitle{{$lesson_item->id}}">   <button class="primary-btn icon-only fix-gr-bg" type="button">
                                ...
                                <div class="modal fade admin-query" id="deleteLessonTitle{{$lesson_item->id}}" >
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('lang.delete') @lang('lang.lesson')</h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                       ...
                                                       <a href="{{route('lesson-item-delete',[$lesson_item->id])}}" class="primary-btn fix-gr-bg">@lang('lang.delete')</a>
        ...
        <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-0">@lang('lang.lesson') @lang('lang.list')</h3>
                </div>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                href="{{route('lesson-edit',[$lesson->class_id,$lesson->section_id,$lesson->subject_id])}}">@lang('lang.edit')</a>
                                                 @endif
