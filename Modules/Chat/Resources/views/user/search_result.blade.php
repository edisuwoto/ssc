...
@section('title')
    @lang('lang.search') @lang('lang.list')  
@endsection
@section('mainContent')
                        ...
                        <div class="chat_flow_list_wrapper ">
                            <div class="box_header">
                                <div class="main-title">
                                    <h3 class="m-0">@lang('lang.search') @lang('lang.results') @lang('lang.of') '{{ $keywords }}'</h3>
                                </div>
                            </div>
                            <!-- chat_list  -->
                            <div class="chat_flow_list crm_full_height">
                                ...
                                <div class="chat_flow_list_inner">
                                    <ul class="list-unstyled">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6">
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label" for="">@lang('lang.username') <span class="text-danger">*</span></label>
                                                                        <input name="name" disabled class="primary_input_field name" placeholder="Name" value="{{ $user->username }}" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-6">
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label" for="">@lang('lang.email') <span class="text-danger">*</span></label>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label" for="">@lang('lang.phone')</label>
                                                                    ...
                                                                    @if($user->blockedByMe())
                                                                        <a href="{{ route('chat.user.block', ['type' => 'unblock', 'user' => $user->id]) }}" class="primary-btn small fix-gr-bg"><span class="ripple rippleEffect" style="width: 30px; height: 30px; top: -6.99219px; left: 19.2578px;"></span>
                                                                            @lang('lang.unblock') @lang('lang.this') @lang('lang.user')
                                                                        </a>
                                                                    @else
                                                                        <a href="{{ route('chat.user.block', ['type' => 'block', 'user' => $user->id]) }}" class="primary-btn small fix-gr-bg"><span class="ripple rippleEffect" style="width: 30px; height: 30px; top: -6.99219px; left: 19.2578px;"></span>
                                                                            @lang('lang.block') @lang('lang.this') @lang('lang.user')
                                                                        </a>
                                                                    @endif
                                                                </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label" for="">@lang('lang.description')</label>
                                                                        <p>
                                                                            {{ $user->description }}
                                                                        </p>
                                                                    </div>
                                        ...
                                        @empty
                                            <p>@lang('lang.no') @lang('lang.user') @lang('lang.found')!</p>
                                        @endforelse
                                    </ul>
                                </div>
                            </div>
