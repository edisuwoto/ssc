...
@section('title') 
@lang('lang.invoice') @lang('lang.settings') 
@endsection
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.invoice') @lang('lang.settings') </h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.bulk_print')</a>   
                <a href="#">@lang('lang.invoice') @lang('lang.settings') </a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-12">
                <form action="{{ route('invoice-settings-update') }}" method="POST">
                    ...
                    <div class="white-box">
                            <div class="row p-0">
                                <div class="col-lg-12">
                                    <h3 class="text-center">@lang('lang.invoice') @lang('lang.settings')</h3>
                                    <hr>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="col-lg-3 d-flex">
                                                    <p class="text-uppercase fw-500 mb-10">@lang('lang.showing')  @lang('lang.page') (@lang('lang.part'))</p>
                                                </div>
                                                <div class="col-lg-9">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('lang.invoice') @lang('lang.prefix') ( @lang('lang.format_standard_three_character') )<span></span></label>
                                    ...
                                    <div class="row mb-40 mt-40">
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                ...
                                                <label>@lang('lang.signature')<span>*</span></label>
                                                <span class="focus-border"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="col-lg-5 d-flex">
                                                    <p class="text-uppercase fw-500 mb-10">@lang('lang.is_showing') @lang('lang.signature')  </p>
                                                </div>
                                                <div class="col-lg-7">
                                                        <div class="radio-btn-flex ml-20">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="">
                                                                    ...
                                                                    <label for="signature_p_on">@lang('lang.yes')</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="">
                                                                    ...
                                                                    <label for="participant_video">@lang('lang.no')</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class=" radio-btn-flex ml-20">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="">
                                                                    ...
                                                                    <label for="signature_c">@lang('lang.yes')</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="">
                                                                    ...
                                                                    <label for="join_before_host">@lang('lang.no')</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class=" radio-btn-flex ml-20">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="">
                                                                    ...
                                                                    <label for="signature_o_on">@lang('lang.yes')</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="">
                                    ...
                                    <div class="row mb-40 mt-40">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                ...
                                                <label>@lang('lang.copy') @lang('lang.for')<span>*</span></label>
                                                <span class="focus-border"></span>
