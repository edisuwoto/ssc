                          ...
                          <th colspan="2">
                            ...
                            <ul>
                              ...
                              <li>
                                ...
                                <p>@lang('lang.invoice') @lang('lang.no') : {{$invoice_no}}</p>
                              </li>
                              <li>
                                <p>
                  ...
                  <footer class="footer" >
                    ...
                    <div class="footer_widget">
                        ...
                        <p class="copy_collect">
                          ...
                          {{ $invoiceSettings->copy_p }} @lang('lang.copy')                 
                          @else
                          @lang('lang.office') @lang('lang.copy')
                          @endif
                        </p>
                    </div>
                    @endif
