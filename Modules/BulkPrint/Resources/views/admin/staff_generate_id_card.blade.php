...
@section('title') 
@lang('lang.generate') @lang('lang.id_card')
@endsection
...
<section class="sms-breadcrumb mb-40 white-box up_breadcrumb">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1> @lang('lang.generate') @lang('lang.staff')  @lang('lang.id_card')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.bulk_print')</a>
                <a href="#"> @lang('lang.staff') @lang('lang.id_card')</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                            ...
                            <div class="col-lg-6 mt-30-md" id="id-card-div">
                                   <div class="col-lg-12 " id="selectSectionsDiv" style="margin-top: -25px;">
                                    <label for="checkbox" class="mb-2">@lang('lang.role') *</label>
