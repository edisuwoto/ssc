...
<body>
    ...
    <div class="invoice_wrapper">
            ...
            <div class="container">
                <div class="invoice_part_iner">
                    ...
                    <div class="table_title">
                        <h3> @lang('lang.payslip') @lang('lang.for_the_period_of') {{$payrollDetail->payroll_month}} {{$payrollDetail->payroll_year}}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="invoice_wrapper_body">
            <h4 class="invoice f_w_400">@lang('lang.payslip') #@if(isset($payrollDetail)){{$payrollDetail->id}} @endif</h4>
            <h4 class="invoice f_w_400 mb_30"> @lang('lang.payment') @lang('lang.date'): @if(isset($payrollDetail))
