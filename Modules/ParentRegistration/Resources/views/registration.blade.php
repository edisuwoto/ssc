                ...
                <div class="col-lg-12">
                    <div class="text-center white-box single_registration_area">
                        ...
                        @if($reg_setting->registration_permission == 1)
                            <form method="POST" class="" action="{{route('parentregistration-student-store')}}" id="parent-registration">
                        @endif
                             {{ csrf_field() }}
                                ...
                                <div class="col-lg-6">
                                    <div class="input-effect">
                                        <select class="niceSelect w-100 bb form-control" name="school" id="select-school">
                                            <option data-display="Select School *" value=""> @lang('lang.select')  @lang('lang.school')  *</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="input-effect" id="academic-year-div">
                                        <select class="niceSelect w-100 bb form-control" name="academic_year" id="select-academic-year">
                                            <option data-display="@lang('lang.select') @lang('lang.academic') @lang('lang.year') *" value="">@lang('lang.select') @lang('lang.academic') @lang('lang.year')</option>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="form-control" type="text" name='first_name' id="school_name" placeholder="@lang('lang.student') @lang('lang.first_name') *" value="{{old('first_name')}}" />
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="form-control" type="text" name='last_name' id="school_name" placeholder="@lang('lang.student') @lang('lang.last_name') *" value="{{old('student_email')}}" />
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="form-control" type="text" name='age' id="age" placeholder="@lang('lang.student') @lang('lang.age')*" readonly=""  value="{{old('age')}}" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="form-control" type="email" name='student_email' id="student_email" placeholder="@lang('lang.student') @lang('lang.email')" value="{{old('student_email')}}"/>
                                    </div>
                            ...
                            <div class="row">
                             ...
                             <div class="row mt-20">
                                <div class="col-lg-12">
                                    <div class="form-group input-group">
                                        <textarea class="form-control" name='how_do_know_us' id="school_name" placeholder="@lang('lang.how_do_you_know_us') ?">{{old('how_do_know_us')}}</textarea>
                                    </div>
                                </div>
                            </div>
