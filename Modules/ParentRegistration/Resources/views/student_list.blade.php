        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <div class="white-box">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'parentregistration/student-list', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'parent-registration']) }}
                            <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <a class="dropdown-item" href="{{route('parentregistration/student-view', [$student->id])}}"  data-id="{{$student->id}}"  >@lang('lang.view')</a>
