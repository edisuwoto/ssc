																			...
																			<table cellspacing="0" cellpadding="0" border="0" width="100%">
																				<tr>
																					<td style="padding:14px 30px 14px 30px;text-transform:uppercase; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align:center; font-size: 14px; font-weight:bold; line-height: 1.3; color:#ffffff;">
																						<a href="{{route('login')}}" style="color:#ffffff; text-decoration:none;" target="_blank">Login </a>
													 ...
													 $chars = preg_split('/[\s,]+/', $body, -1, PREG_SPLIT_NO_EMPTY | PREG_SPLIT_DELIM_CAPTURE);
													    ...
													    foreach($chars as $item){
													        if(strstr($item[0],"[")){
													            ...
													            $custom_array[$item]= App\SmsTemplate::getValueByStringTestApprove($compact, $str);
													        } 
