...
class SmItemReceiveController extends Controller
{
    ...
    public function itemReceive()
    {
        try {
            ...
            $suppliers = SmSupplier::where('active_status', '=', 1)
                ->where('school_id', Auth::user()->school_id)
                ->get();
    ...
    {
        try {
            $allItemReceiveLists = SmItemReceive::where('active_status', '=', 1)
                ->where('school_id', Auth::user()->school_id)
                ->get();
    ...
    public function editItemReceive(Request $request, $id)
    {
        try {
            ...
            $editDataChildren = SmItemReceiveChild::where('item_receive_id', $id)
                ->where('school_id', Auth::user()->school_id)
                ->get();
    ...
    public function updateItemReceiveData(Request $request, $id)
    {
        ...
        try {
            ...
            $delete_item_receive_id = SmAddExpense::where('item_receive_id', $itemReceives->id)->delete();
            ...
            if(paymentMethodName($request->payment_method)){
                $delete_item_receive = SmBankStatement::where('item_receive_id', $itemReceives->id)
                                    ->where('school_id',Auth::user()->school_id)
                                    ->delete();
