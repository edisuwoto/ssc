            ...
            foreach ($students as $student) {
                ...
                foreach ($fees_assigns as $fees_assign) {
                    ...
                    foreach ($fees_masters as $fees_master) {
                        $total_collection = $total_collection + SmFeesPayment::where('active_status',1)->where('academic_id', getAcademicId())->where('student_id', $student->id)->where('fees_type_id', $fees_master->fees_type_id)->sum('amount');
                    }
                }
