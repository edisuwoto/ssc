                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="primary_input mb-25">
                                                                <label class="primary_input_label" for="title">
                                                                    @lang('lang.navigation') @lang('lang.label') 
                                                            ...
                                                            <div class="d-flex justify-content-center pt_20">
                                                                @if(env('APP_SYNC')==TRUE)
                                                                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo ">
                                                                        <button class="primary-btn fix-gr-bg" style="pointer-events: none;" type="button" > @lang('lang.update')</button>
                                                                    </span>
                                                                @else
                                                                    @if(userPermission(652))
                                    ...
                                    <li class="dd-item" data-id="{{$element->id}}">
                                        <div class="card accordion_card" id="accordion_{{$element->id}}">
                                            <div class="card-header item_header" id="heading_{{$element->id}}">
                                                ...
                                                <div class="pull-right btn_div">
                                                    @if(userPermission(652))
                                                        <a href="javascript:void(0);" onclick="" data-toggle="collapse" data-target="#collapse_{{$element->id}}" aria-expanded="false" aria-controls="collapse_{{$element->id}}" class="primary-btn btn_zindex panel-title">@lang('lang.edit') <span class="collapge_arrow_normal"></span></a>
                                                    @endif
                                                    @if(env('APP_SYNC')==TRUE)
                                                        <a href="javascript:void(0);" class="primary-btn btn_zindex" title="Disable For Demo" data-toggle="tooltip">
                                                            <i class="ti-close"></i>
...
@else
    <div class="card">
        <div class="card-body text-center">
            @lang('lang.not') @lang('lang.found') @lang('lang.data')
        </div>
    </div>
@endif