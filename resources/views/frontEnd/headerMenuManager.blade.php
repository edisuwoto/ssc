@extends('backEnd.master')
    @section('title')
        @lang('lang.header') @lang('lang.menu') @lang('lang.manager') 
    @endsection
@section('mainContent')
@push('css')
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.header') @lang('lang.menu') @lang('lang.manager')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.front_settings')</a>
                <a href="#">@lang('lang.header') @lang('lang.menu') @lang('lang.manager')</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30">
                                @lang('lang.add') @lang('lang.header') @lang('lang.menu')
                            </h3>
                        </div>
            ...
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-30">@lang('lang.menu') @lang('lang.list')</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12" id="menuList">
                        @include('frontEnd.headerSubmenuList')
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        <a class="primary-btn fix-gr-bg" id="delete-item" href="#">@lang('lang.delete')</a>
                    </div>
                </div>
            </div>
        </div>
