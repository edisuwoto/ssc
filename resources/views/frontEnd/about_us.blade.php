...
@section('title')
@lang('lang.about') @lang('lang.page')
@endsection
@section('mainContent')
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('lang.about') @lang('lang.page')</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                    <a href="#">@lang('lang.front_settings')</a>
                    <a href="#">@lang('lang.about') @lang('lang.page')</a>
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="input-effect mt-25">
                                                ...
                                                <label>@lang('lang.button') @lang('lang.text')<span>*</span></label>
                                                <span class="focus-border"></span>
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" id="placeholderInput" type="text"
                                                       placeholder="{{isset($update)? ($about_us->image !="") ? getFilePath3($about_us->image) :trans('lang.image') .' *' :trans('lang.image') .' *' }}"
                                                       readonly>
                                                <span class="focus-border"></span>
                                                @if($errors->has('image'))
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control{{ $errors->has('main_image') ? ' is-invalid' : '' }}" id="placeholderInputMainFile" type="text"
                                                       placeholder="{{isset($update)? ($about_us->main_image !="") ? getFilePath3($about_us->main_image) :trans('lang.main') .' '. trans('lang.image') .' *' :trans('lang.main') .' '. trans('lang.image') .' *' }}"
                                                       readonly>
                                                <span class="focus-border"></span>
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-30">@lang('lang.info')</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12 scroll_table">
                            ...
                            <table class="display school-table school-table-style" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th width="10%">@lang('lang.button') @lang('lang.text')</th>
                                    ...
                                    <td width="20%">
                                        @if($about_us != "")
                                            ...
                                            @if(userPermission(522))
                                                <a href="{{route('about-page/edit')}}" class="primary-btn small fix-gr-bg">@lang('lang.edit')</a>
                                            @endif
                                        @endif
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog modal-dialog-centered max_modal">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('lang.about_us') @lang('lang.details') </h4>
