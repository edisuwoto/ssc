...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.create') @lang('lang.page')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.front_settings')</a>
                <a href="#">@lang('lang.create') @lang('lang.page')</a>
            </div>
        </div>
    </div>
</section>
                            ...
                            <div class="add-visitor">
                                ...
                                <div class="row  mt-40">
                                    ...
                                    <div class="col-lg-6">
                                            ...
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input
                                                        ...
                                                        placeholder="{{isset($editData->header_image) && @$editData->header_image != ""? getFilePath3(@$editData->header_image):trans('lang.image'). ' '. trans('lang.header') . '(' .trans('lang.min')." 1420*450 PX)"}}"
                                        ...
                                        @isset($editData)
                                            <a class="btn btn-primary cust-class pull-right" href="{{route('view-page', ['slug'=>@$editData->slug])}}" target="blank">@lang('lang.preview')</a>
                                        @endisset
                                ...
                                <div class="row  mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.sub_title')</label>
                                            <span class="focus-border"></span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">
                        @lang('lang.image') @lang('lang.preview')
                    </h4>
