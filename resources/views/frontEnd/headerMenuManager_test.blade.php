...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.header') @lang('lang.menu')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.front_settings')</a>
                <a href="#">@lang('lang.header') @lang('lang.menu')</a>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="main-title">
                            <h3 class="mb-30">
                                ...
                                @else
                                    @lang('lang.add')
                                @endif
                                @lang('lang.header') @lang('lang.menu')
                            </h3>
                        </div>
                        @if(isset($editData))
                                ...
                                <div class="row  mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.slug') <span>*</span></label>
                                            <span class="focus-border"></span>
                                            @if ($errors->has('slug'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="row  mt-40">
                                    <div class="col-lg-12">
                                        <select class="niceSelect w-100 bb form-control{{ @$errors->has('status') ? ' is-invalid' : '' }}" name="status">
                                            ...
                                            <option value="1" {{@$editData->active_status == '1'? 'selected':old('status') == ('1'? 'selected':'') }}>@lang('lang.active')</option>
                                            <option value="0" {{@$editData->active_status == '0'? 'selected':old('status') == ('0'? 'selected':'') }}>@lang('lang.inactive')</option>
                                        </select>
                                        <span class="focus-border"></span>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('lang.header') @lang('lang.menu') @lang('lang.list')</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <tr data-id="{{$menu->id}}">
                                    ...
                                    <td>
                                        @if ($menu->active_status == 1)
                                            <button class="primary-btn small bg-success text-white border-0">@lang('lang.active')</button>
                                        @else
                                        <button class="primary-btn small bg-warning text-white border-0">@lang('lang.inactive')</button>
                                        @endif
                                    <td>
                                        <div class="dropdown">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('lang.delete') @lang('lang.menu')</h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    ...
                                                    <a class="primary-btn fix-gr-bg" href="{{route('delete-header-menu', ['id'=>$menu->id])}}">@lang('lang.delete')</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
