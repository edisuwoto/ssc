            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs mb-50 ml-0" role="tablist">
                        @if ($course->overview)
                            <li class="nav-item">
                                <a class="nav-link active" href="#overviewTab" role="tab" data-toggle="tab">@lang('lang.overview')</a>
                            </li>
                        @endif
                        @if ($course->outline)
                            <li class="nav-item">
                                <a class="nav-link" href="#outlineTab" role="tab" data-toggle="tab">@lang('lang.outline')</a>
                            </li>
                        @endif
                        @if ($course->prerequisites)
                            <li class="nav-item">
                                <a class="nav-link" href="#prerequisitesTab" role="tab" data-toggle="tab">@lang('lang.prerequisites')</a>
                            </li>
                        @endif
                        @if ($course->resources)
                            <li class="nav-item">
                                <a class="nav-link" href="#resourcesTab" role="tab" data-toggle="tab">@lang('lang.resources')</a>
                            </li>
                        @endif
                        @if ($course->stats )
                            <li class="nav-item">
                                <a class="nav-link" href="#statsTab" role="tab" data-toggle="tab">@lang('lang.stats')</a>
                            </li>
                        @endif
                    </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="title">@lang('lang.related_courses')</h3>
                        </div>
                    </div>
                    <div class="row">
