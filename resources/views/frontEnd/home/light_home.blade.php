            ...
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-5 text-md-right text-left mb-30-lg">
                                <a href="{{url('news-page')}}"
                                   class="primary-btn small fix-gr-bg">@lang('lang.browse_all')</a>
                            </div>
                        </div>
                        <div class="row">
                ...
                @if(isset($per["Notice Board"]))
                    <div class="col-lg-3 notice-board-area">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="title">@lang('lang.notice_board')</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-6 col-md-7">
                                <h3 class="title">@lang('lang.course_list')</h3>
                            </div>
                            <div class="col-lg-6 col-md-5 text-md-right text-left mb-30-lg">
                                <a href="{{url('course')}}"
                                   class="primary-btn small fix-gr-bg">@lang('lang.browse_all')</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row mb-40">
                            <div class="col-lg-6 col-md-7">
                                <h3 class="title">@lang('lang.event_ist')</h3>
                            </div>
                            <div class="col-lg-6 col-md-5 text-md-right text-left mb-30-lg">
                                <a href="#" class="primary-btn small fix-gr-bg">@lang('lang.browse_all')</a>
                            </div>
                        </div>
                        <div class="row">
