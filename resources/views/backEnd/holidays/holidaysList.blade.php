...
@section('title')
@lang('lang.holiday') @lang('lang.list')
@endsection 
@section('mainContent')
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control" name="upload_file_name"
                                                       type="text"
                                                       placeholder="{{isset($editData->upload_image_file) && $editData->upload_image_file != ""? getFilePath3($editData->upload_image_file):trans('lang.attach_file')}}"
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="upload_holiday_image">@lang('lang.browse')</label>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @if(userPermission(442))
                                                            <a class="dropdown-item"
                                                               href="{{url('holiday/'.$value->id.'/edit')}}">@lang('lang.edit')</a>
                                                        @endif
                                                        @if(userPermission(443))
                                                            <a class="deleteUrl dropdown-item"
                                                               data-modal-size="modal-md" title="Delete Holiday"
                                                               href="{{url('delete-holiday-data-view/'.$value->id)}}">@lang('lang.delete')</a>
                                                        @endif
