...
@section('title') 
@lang('lang.sms')/@lang('lang.email') @lang('lang.template')
@endsection
                            ...
                            <div class="add-visitor">
                                <div class="row mt-25">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="input-effect">
                                            <label>@lang('lang.dues_fees_message') <span></span></label>
                                ...
                                <div class="row mt-25">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="input-effect">
                                            <label>@lang('lang.student_absent_notification_sms') <span></span></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="">
                                                                ...
                                                                <label for="student_absent_notification_sms_smsF">@lang('lang.enable')</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="">
                                                                ...
                                                                <label for="student_absent_notification_sms_smsM">@lang('lang.disable')</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
