...
@section('title') 
    @lang('lang.administrator') @lang('lang.notices')
@endsection
                            ...
                            @if(userPermission(289))
                             ...
                             @endif
                              @if(userPermission(290))
                                <a class="deleteUrl" data-modal-size="modal-md" title="Delete Notice" href="{{route('delete-notice-view',$value->id)}}"><button class="primary-btn small tr-bg">@lang('lang.delete') </button></a>
                            @endif
                            </div>
                        </div>
                    </a>
