                        ...
                        <div class="col-lg-5">
                            <div class="name">
                                @if(isset($ContentDetails))
                                    ...
                                    <p>@lang('lang.section'): All Sections</p>
                                @endif
                                ...
                                @if(isset($ContentDetails))
                                    @if(@$ContentDetails->source_url != "")
                                        @if (moduleStatusCheck('VideoWatch')== TRUE)
                                                <a class="primary-btn small fix-gr-bg" target="_blank" href="{{url('videowatch/view/'.$ContentDetails->id)}}">@lang('lang.click_here')</a>
                                        @else
                        ...
                        <div class="name">
                            ...
                            @endphp
                             ...
                             @if ($files_ext=='jpg' || $files_ext=='jpeg' || $files_ext=='heic' || $files_ext=='png'|| $files_ext=='mp4'|| $files_ext=='mp3'|| $files_ext=='mov'|| $files_ext=='pdf')
                                ...
                                @else 
                                    <a href="{{url(@$ContentDetails->upload_file)}}" download> @lang('lang.download')  <span class="pl ti-download"></span>
                                @endif
                             </a>
                            @endif
                        </div>
