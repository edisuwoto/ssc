                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-30">@lang('lang.online_exam')</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="white-box">
                                ...
                                <div class="">
                                    <div class="row  pl-10">
                                        <div class="col-lg-7 mt-20">
                                            <h3>@lang('lang.exam_name') : {{@$online_exam->title}}</h3>
                                                        <h4><strong>@lang('lang.subject') : </strong>{{@$online_exam->subject !=""?@$online_exam->subject->subject_name:""}}</h4>
                                                        <h4><strong>@lang('lang.class_Sec') : </strong>{{@$online_exam->class !=""?@$online_exam->class->class_name:""}} ({{@$online_exam->section !=""?@$online_exam->section->section_name:""}})</h4>
                                                        <h4 class="mb-20"><strong>@lang('lang.total_marks') : </strong>
                                                        @php
                                                        @$total_marks = 0;
                                                            ...
                                                            echo @$total_marks;
                                                        @endphp</h4>
                                        <p><strong>@lang('lang.instruction') : </strong>{{@$online_exam->instruction}}</p>
                                        </div>
                                        <div class="col-lg-5 mt-20">
                                            <p class="mb-2"><strong>@lang('lang.date') & @lang('lang.time'): </strong>{{dateConvert(@$online_exam->date)}} {{dateConvert(@$online_exam->end_time)}}</p>
                            ...
                            <table  class="" cellspacing="0" width="100%">
                                ...
                                @php
                                    ...
                                    $k = 0;
                                @endphp
                                    <h4>[@lang('lang.currect_answer')]</h4>
                                <div class="quiestion_group">
                                    @php
