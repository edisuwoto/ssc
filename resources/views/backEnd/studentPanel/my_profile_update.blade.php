...
@endsection
@section('title')
@lang('lang.profile') @lang('lang.update') 
@endsection
    ...
    <section class="sms-breadcrumb up_breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('lang.profile') @lang('lang.update') </h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                    <a href="{{route('student_list')}}">@lang('lang.student_list')</a>
                    <a href="#">@lang('lang.profile') @lang('lang.update') </a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row mb-30">
                <div class="col-lg-6">
                    <div class="main-title">
                        <h3>@lang('lang.profile') @lang('lang.update') </h3>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('blood_group') ? ' is-invalid' : '' }}"
                                                name="blood_group">
                                            <option data-display="@lang('lang.blood_group')"
                                                    value="">@lang('lang.blood_group')</option>
                                ...
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('religion') ? ' is-invalid' : '' }}"
                                                name="religion">
                                            <option data-display="@lang('lang.religion')"
                                                    value="">@lang('lang.religion')</option>
                                        ...
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('student_category_id') ? ' is-invalid' : '' }}"
                                                ...
                                                <option data-display="@lang('lang.category')"
                                                        value="">@lang('lang.category')</option>
                                    ...
                                    <div class="input-effect">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('student_group_id') ? ' is-invalid' : '' }}"
                                                ...
                                                <option data-display="@lang('lang.group')"
                                                        value="">@lang('lang.group')</option>
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="document_file_2">@lang('lang.browse')</label>
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="document_file_3">@lang('lang.browse')</label>
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        <button type="button" class="primary-btn fix-gr-bg" data-dismiss="modal"
                                id="yesRemoveSibling">@lang('lang.delete')</button>
