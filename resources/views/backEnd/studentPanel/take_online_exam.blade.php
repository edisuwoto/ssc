    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('student_online_exam')}}">@lang('lang.online_exam')</a>
                <a href="{{route('take_online_exam',@$online_exam->id)}}">@lang('lang.take_online_exam')</a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <tbody>
                                    <tr align="center" class="exam-bg">
                                        <td colspan="2" class="pt-4 pb-3 px-sm-5">
                                            ...
                                            <h2><strong>@lang('lang.subject') : </strong>{{@$online_exam->subject !=""?@$online_exam->subject->subject_name:""}}</h2>
                                            <h6><strong>@lang('lang.class_Sec') : </strong>{{@$online_exam->class !=""?@$online_exam->class->class_name:""}} ({{@$online_exam->section !=""?@$online_exam->section->section_name:""}})</h6>
                                            <h3 class="mb-20"><strong>@lang('lang.total_marks') : </strong>
                                            @php
                                            @$total_marks = 0;
