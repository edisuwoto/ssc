            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($postal_dispatch))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => array('postal-dispatch_update',@$postal_dispatch->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                        @else
                         @if(userPermission(33))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'postal-dispatch',
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row no-gutters input-right-icon mt-35">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input" id="placeholderInput" type="text" placeholder="{{isset($postal_dispatch)? ($postal_dispatch->file != ""? getFilePath3($postal_dispatch->file):trans('lang.file')):trans('lang.file')}}" readonly>
                                            <span class="focus-border"></span>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  data-sort="{{strtotime(@$postal_dispatch->date)}}" >{{ !empty($postal_dispatch->date)? dateConvert( @$postal_dispatch->date):''}} </td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{route('postal-dispatch_edit', @$postal_dispatch->id
                                                    )}}">@lang('lang.edit')</a>
                                               @endif
                                               ...
                                               <a class="dropdown-item" data-toggle="modal" data-target="#deletePostalReceiveModal{{@$postal_dispatch->id}}"
                                                ...
                                                @endif
                                                  ...
                                                  @if (@file_exists($postal_dispatch->file))
                                                        <a class="dropdown-item" href="{{url(@$postal_dispatch->file)}}" download>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                     {{ Form::open(['route' => array('postal-dispatch_delete', @$postal_dispatch->id), 'method' => 'DELETE', 'enctype' => 'multipart/form-data']) }}
