                    ...
                    <div class="user_id_card_header mt-30">
                        <h4 id="titleV">
                            @if(isset($id_card))
                                {{$id_card->title}}
                            @else
                                @lang('lang.user') @lang('lang.id_card')
                            @endif
                        </h4>
                    </div>
                    <div class="mt-10">
...
@push('scripts')
    {{-- <script>
        ...
        let pageLayout = $( "#pageLayoutStyle option:selected" ).val();
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                $("body").on("change", "#applicableUser", function(e) {
                    ...
                    if (userType == "0") {
                        ...
                        if(pageLayout == "horizontal"){
                            ...
                            $('#horizontal').addClass('d-none');
                            $('#vertical').addClass('d-none');
                            $('#pWidth').html('(@lang('lang.default') 55 mm)');
                            $('#pHeight').html('(@lang('lang.default') 106 mm)');
                            $('#profileWidth').html('(@lang('lang.default') 21 mm)');
                            $('#profileHeight').html('(@lang('lang.default') 21 mm)');
                        }else{
                            $('#horizontal').addClass('d-none');
                            ...
                            $('#pWidth').html('(@lang('lang.default') 106 mm)');
                            $('#pHeight').html('(@lang('lang.default') 55 mm)');
                            $('#profileWidth').html('(@lang('lang.default') 21 mm)');
                            $('#profileHeight').html('(@lang('lang.default') 21 mm)');
                        }
                        ...
                        $('.text').html('@lang('lang.admission_no')');
            ...
            $(document).on("click", "#deleteSignImg", function(event) {
                ...
                if(pageLayout == "horizontal"){
                    $('.hSign').css('background-image','url({{asset('public/backEnd/id_card/img/Signature.png')}})');
                }else{
                    $('.vSign').css('background-image','url({{asset('public/backEnd/id_card/img/Signature.png')}})');
                }
            });
