...
@section('title') 
    @lang('lang.id_card') @lang('lang.list')
@endsection
@section('mainContent')
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.id_card')</h1>
            <div class="bc-pages">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="{{route('student-id-card-edit',['id' => $id_card->id])}}">@lang('lang.edit')</a>
                                                                        ...
                                                                        <div class="card_text" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; flex-direction: column;">
                                                                                ...
                                                                                <div class="card_text_left hId">
                                                                                    ...
                                                                                    @if($id_card->admission_no==1 )
                                                                                        <div id="hAdmissionNumber">
                                                                                            @if($role_id==2)
                                                                                                <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.admission_no') : 001</h3>
                                                                                            @else 
                                                                                                <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.id') : 001</h3>
                                                                                            @endif
                                                                                        </div>
                                                                                    @endif
                                                                                    @if(in_array(2,$roleId))
                                                                                        @if($id_card->class==1)
                                                                                            <div id="hClass">
                                                                                                <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.class') : One (A)</h3>
                                                                                            </div>
                                                                                        @endif
                                                                                    @endif
                                                                                </div>
                                                                            ...
                                                                            <div class="card_text_head hStudentName" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:10px"> 
                                                                                <div class="card_text_left">
                                                                                    @if($id_card->father_name ==1)
                                                                                        <div id="hFatherName">
                                                                                            <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.father_name') : InfixEdu</h4>
                                                                                        </div>
                                                                                    @endif
                                                                                    @if($id_card->mother_name==1)
                                                                                        <div id="hMotherName">
                                                                                            <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px; font-weight:500">@lang('lang.mother_name') : InfixEdu</h4>
                                                                                        </div>
                                                                                    @endif
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="card_text_head " style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:10px"> 
                                                                                <div class="card_text_left">
                                                                                    @if($id_card->dob==1)
                                                                                        <div id="hDob">
                                                                                            <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.date_of_birth') :  Dec 25 , 2022</h3>
                                                                                        </div>
                                                                                    @endif
                                                                                    @if(in_array(2,$roleId))
                                                                                        @if($id_card->blood==1)
                                                                                            <div id="hBloodGroup">
                                                                                                <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.blood_group') : B+</h3>
                                                                                            </div>
                                                                                        @endif
                                                                                    @endif
                                                                                </div>
                                                                        ...
                                                                        <div class="card_text" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; flex-direction: column;">
                                                                            <div class="card_text_head" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:5px"> 
                                                                                <div class="card_text_left vId">
                                                                                    ...
                                                                                    @if($id_card->admission_no==1)
                                                                                        <div id="vAdmissionNumber">
                                                                                            @if(in_array(2,$roleId))
                                                                                                <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px;">@lang('lang.admission_no') : 001</h4>
                                                                                            @else 
                                                                                                <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px;">@lang('lang.id') : 001</h4>
                                                                                            @endif
                                                                                        </div>
                                                                                    @endif
                                                                                    @if(in_array(2,$roleId))
                                                                                        @if($id_card->class==1)
                                                                                            <div id="vClass">
                                                                                                <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px;">@lang('lang.class') :  One (A)</h4>
                                                                                            </div>
                                                                                        @endif
                                                                                    @endif
                                                                                </div>
                                                                                <div class="card_text_right">
                                                                                    ...
                                                                                    @if($id_card->dob==1)
                                                                                        <div id="vDob">
                                                                                            <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500;">@lang('lang.date_of_birth') :   jan 21. 2030</h3>
                                                                                        </div>
                                                                                    @endif
                                                                                    @if(in_array(2,$roleId))
                                                                                        @if($id_card->blood==1)
                                                                            ...
                                                                            <div class="card_text_head " style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:5px"> 
                                                                                <div class="card_text_left">
                                                                                    @if($id_card->father_name ==1)
                                                                                        <div id="vFatherName">
                                                                                            <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.father_name') : InfixEdu</h3>
                                                                                        </div>
                                                                                    @endif
                                                                                    @if($id_card->mother_name==1)
                                                                                        <div id="vMotherName">
                                                                                            <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.mother_name') : InfixEdu</h3>
                                                                                        </div>
                                                                                    @endif
                                                                                </div>
                                                                                <div class="card_text_right">
