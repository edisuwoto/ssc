...
<html>
<head>
    <title> @if($role_id==2) @lang('lang.student_id_card') @else @lang('lang.staff_ID') @endif</title>
                                                ...
                                                <div class="card_text" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; flex-direction: column;">
                                                        ...
                                                        <div class="card_text_left hId">
                                                            ...
                                                            @if($id_card->admission_no==1 )
                                                                <div id="hAdmissionNumber">
                                                                    @if($role_id==2)
                                                                        <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.admission_no') : {{$staff_student->admission_no}}</h3>
                                                                    @else 
                                                                        <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.staff_ID') : {{$staff_student->staff_no}}</h3>
                                                                    @endif
                                                                </div>
                                                            @endif
                                                            @if($id_card->class==1 && $role_id==2)
                                                                <div id="hClass">
                                                                    <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.class') : {{ @$staff_student->className!=""?@$staff_student->className->class_name:""}} 
                                                    ...
                                                    <div class="card_text_head hStudentName" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:10px"> 
                                                        <div class="card_text_left">
                                                            @if($id_card->father_name ==1)
                                                                <div id="hFatherName">
                                                                    <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.father_name') :@if($role_id==2) {{@$staff_student->parents !=""?@$staff_student->parents->fathers_name:""}}@else {{$staff_student->fathers_name}} @endif</h4>
                                                                </div>
                                                            @endif
                                                            @if($id_card->mother_name==1)
                                                                <div id="hMotherName">
                                                                    <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px; font-weight:500">@lang('lang.mother_name') :@if($role_id==2) {{@$staff_student->parents !=""?@$staff_student->parents->mothers_name:""}} @else {{$staff_student->mothers_name}} @endif</h4>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card_text_head " style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:10px"> 
                                                        <div class="card_text_left">
                                                            @if($id_card->dob==1)
                                                                <div id="hDob">
                                                                    <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.date_of_birth') :  {{@dateConvert($staff_student->date_of_birth)}}</h3>
                                                                </div>
                                                            @endif
                                                            @if($id_card->blood==1 && $role_id==2)
                                                                <div id="hBloodGroup">
                                                                    <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.blood_group') : {{@$staff_student->bloodGroup!=""?@$staff_student->bloodGroup->base_setup_name:""}}</h3>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card_text" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; flex-direction: column;">
                                                        ...
                                                        <div class="card_text_left vId">
                                                            ...
                                                            @if($id_card->admission_no==1)
                                                                <div id="vAdmissionNumber">
                                                                    @if($role_id==2)
                                                                        <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px;">@lang('lang.admission_no') : {{$staff_student->admission_no}}</h4>
                                                                    @else 
                                                                        <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px;">@lang('lang.staff_ID') : {{$staff_student->staff_no}}</h4>
                                                                    @endif
                                                                </div>
                                                            @endif
                                                            @if($id_card->class==1 &&  $role_id==2)
                                                                <div id="vClass">
                                                                    <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px;">@lang('lang.class') : {{ @$staff_student->className!=""?@$staff_student->className->class_name:""}} 
                                                                        ({{ @$staff_student->section!=""?@$staff_student->section->section_name:""}})
                                                                    </h4>
                                                                </div>
                                                            @endif
                                                    ...
                                                    <div class="card_text_head " style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:5px"> 
                                                        <div class="card_text_left">
                                                            @if($id_card->father_name ==1)
                                                                <div id="vFatherName">
                                                                    <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.father_name') :@if($role_id==2) {{@$staff_student->parents !=""?@$staff_student->parents->fathers_name:""}}@else {{$staff_student->fathers_name}} @endif</h3>
                                                                </div>
                                                            @endif
                                                            @if($id_card->mother_name==1)
                                                                <div id="vMotherName">
                                                                    <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500">@lang('lang.mother_name') :@if($role_id==2) {{@$staff_student->parents !=""?@$staff_student->parents->mothers_name:""}} @else {{$staff_student->mothers_name}} @endif</h3>
                                                                </div>
                                                            @endif
                                                        </div>
                                                        <div class="card_text_right">
                                                ...
                                                <div class="card_text" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; flex-direction: column;">
                                                    <div class="card_text_head " style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:0px"> 
                                                        ...
                                                        <div class="card_text_right">
                                                            ...
                                                            @if($id_card->phone_number == 1)
                                                                <div id="gVAddress">
                                                                    <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500;">@lang('lang.phone') : {{$staff_student->guardians_mobile}}</h3>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
