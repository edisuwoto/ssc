                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row no-gutters input-right-icon mt-35">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('file') ? ' is-invalid' : '' }}" id="placeholderInput" type="text" placeholder="{{isset($certificate)? ($certificate->file != ""? getFilePath3($certificate->file):trans('lang.image') .' *'): trans('lang.image') .' (1100 X 850)px *'}}" readonly>
                                            <span class="focus-border"></span>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{route('student-certificate-edit',@$certificate->id)}}">@lang('lang.edit')</a>
                                                @endif
