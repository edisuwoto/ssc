            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'postal-receive',
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row no-gutters input-right-icon mt-35">
                                    <div class="col">
                                        <div class="input-effect">
                                            <input class="primary-input" id="placeholderInput" type="text" placeholder="{{isset($postal_receive)? ($postal_receive->file != ""? getFilePath3($postal_receive->file):trans('lang.file')):trans('lang.file')}}" readonly>
                                            <span class="focus-border"></span>
                                            @if ($errors->has('file'))
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  data-sort="{{strtotime(@$postal_receive->date)}}" >{{ !empty($postal_receive->date)? dateConvert(@$postal_receive->date):''}} </td>
                                    <td>
                                        <div class="dropdown">
                                                ...
                                                @endif
                                                  ...
                                                  @if(userPermission(31))
                                                    @if (@file_exists($postal_receive->file))
                                                        <a class="dropdown-item" href="{{url(@$postal_receive->file)}}" download>
