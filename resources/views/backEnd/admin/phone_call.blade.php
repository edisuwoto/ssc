            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($phone_call_log))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => array('phone-call_update',@$phone_call_log->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                        @else
                        @if(userPermission(37))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'phone-call',
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{route('phone-call_edit', @$phone_call_log->id
                                                    )}}">@lang('lang.edit')</a>
                                                    @endif
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                     {{ Form::open(['route' => array('phone-call_delete',@$phone_call_log->id), 'method' => 'DELETE', 'enctype' => 'multipart/form-data']) }}
