...
@section('title') 
@lang('lang.bank')  @lang('lang.payment')
@endsection
@section('mainContent')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 sm_mb_20 sm2_mb_20">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('approve_status') ? ' is-invalid' : '' }}" name="approve_status">
                                        ...
                                        <option value="0" {{isset($approve_status)? ($approve_status == 0? 'selected': ''):'' }}>@lang('lang.pending')</option>
                                        <option value="1" {{isset($approve_status)? ($approve_status == 1? 'selected': ''):'' }}>@lang('lang.approved')</option>
                                    </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($bank_slip->slip))
                                                <a class="text-color" data-toggle="modal" data-target="#showCertificateModal{{ @$bank_slip->id}}"  href="#">@lang('lang.view')</a>
                                            @endif
                                        </td>
                                        <td>
                                            ...
                                            @else
                                                <button class="primary-btn small bg-success text-white border-0  tr-bg">@lang('lang.approved')</button>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a onclick="enableId({{$bank_slip->id}});" class="dropdown-item" href="#" data-toggle="modal" data-target="#enableStudentModal" data-id="{{$bank_slip->id}}"  >@lang('lang.approve')00</a>
                                                    <a onclick="rejectPayment({{$bank_slip->id}});" class="dropdown-item" href="#" data-toggle="modal" data-id="{{$bank_slip->id}}"  >@lang('lang.reject')</a>
                                                </div>
                                                @endif
                                            </div>
                                        </td>
                                                    ...
                                                    <div class="container student-certificate">
                                                        <div class="row justify-content-center">
                                                            <div class="col-lg-12 text-center">
                                                                ...
                                                                @if (@$for_pdf=="pdf")
                                                                    <div class="mb-5">
                                                                        <a href="{{url(@$bank_slip->slip)}}" download>@lang('lang.download') <span class="pl ti-download"></span></a>
                                                                    </div>
                                                                @else
                                                                    <div class="mb-5">
...
<div class="modal fade admin-query" id="rejectPaymentModal" >
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">@lang('lang.bank')  @lang('lang.payment') @lang('lang.reject') </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="text-center">
                        <h4>@lang('lang.are_you_sure_to_reject')</h4>
                    </div>
              {{ Form::open(['route' => 'reject-fees-payment', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                <div class="form-group">
                    <input type="hidden" name="id" id="showId">
                    <label><strong>@lang('lang.reject')  @lang('lang.note')</strong></label>
...
<div class="modal fade admin-query" id="showReasonModal" >
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">@lang('lang.view') @lang('lang.bank')  @lang('lang.payment') @lang('lang.reject')  @lang('lang.note')</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="form-group">
