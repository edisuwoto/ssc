...
@section('title') 
@lang('lang.fees') @lang('lang.bulk') @lang('lang.print')
@endsection
@section('mainContent')
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.fees') @lang('lang.bulk') @lang('lang.print')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.fees_collection')</a>
                <a href="#">@lang('lang.report')</a>
                <a href="#">@lang('lang.fees') @lang('lang.bulk') @lang('lang.print')</a>
            </div>
        </div>
    </div>
</section>
