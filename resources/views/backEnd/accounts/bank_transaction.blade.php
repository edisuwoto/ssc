...
@section('title') 
@lang('lang.bank') @lang('lang.transaction')
@endsection
@section('mainContent')
@push('css')
<style>
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.bank') @lang('lang.transaction')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.accounts')</a>
                <a href="#">@lang('lang.bank') @lang('lang.transaction')</a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('lang.bank') @lang('lang.transaction') ({{$bank_name->bank_name .' '.'-'.' '. $bank_name->account_name}})</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <table id="tableWithoutSort" class="display school-table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th><span class="text-right d-block">@lang('lang.balance')</span></th>
                                </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td>@lang('lang.opening_balance')</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                ...
                                @php 
                                    ...
                                    $total_debit = 0;
                                @endphp
                            @foreach($bank_transcations as $value)
                            @php
                                if($value->type==1){
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="text-right">@lang('lang.current') @lang('lang.balance'):</th>
