...
@section('title') 
@lang('lang.fine') @lang('lang.report')
@endsection
@section('mainContent')
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.fine') @lang('lang.report')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.accounts')</a>
                <a href="#">@lang('lang.reports')</a>
                <a href="#">@lang('lang.fine') @lang('lang.report')</a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-6 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('lang.fine') @lang('lang.report')</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
