...
@section('title') 
@lang('lang.add') @lang('lang.income')
@endsection
@section('mainContent')
                                ...
                                <div class="row mt-25 d-none" id="bankAccount">
                                    <div class="col-lg-12">
                                        <select class="niceSelect w-100 bb form-control{{ @$errors->has('accounts') ? ' is-invalid' : '' }}" name="accounts">
                                            <option data-display="@lang('lang.bank') @lang('lang.accounts') *" value="">@lang('lang.bank') @lang('lang.accounts') *</option>
                                ...
                                <div class="row  mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.amount') ({{generalSetting()->currency_symbol}}) <span>*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-25">
                                     <div class="col">
                                        <div class="row no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input" type="text" id="placeholderFileOneName" placeholder="{{isset($add_income)? ($add_income->file != ""? getFilePath3($add_income->file):trans('lang.file')):trans('lang.file') }}" readonly
                                                        >
                                                    <span class="focus-border"></span>
                                                    @if ($errors->has('file'))
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{@$add_income->paymentMethod !=""?@$add_income->paymentMethod->method:trans('lang.bank')}} {{@$add_income->payment_method_id == "3"? '('.@$add_income->account->account_name.')':''}}</td>
                                    <td data-sort="{{strtotime(@$add_income->date)}}" >{{@$add_income->date != ""? dateConvert(@$add_income->date):''}}</td>
                                            ...
                                            @if ($add_income->name != "Opening Balance")
                                                ...
                                                @if(@$add_income->file != "")
                                                    ...
                                                    @if(userPermission(142))
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#deleteAddIncomeModal{{@$add_income->id}}">@lang('lang.delete')</a>
                                                    @endif
                                                </div>
                                            @endif
                                        </div>
