                                ...
                                <div class="row mt-25">
                                     <div class="col">
                                        <div class="row no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input" type="text" id="placeholderFileOneName" placeholder="{{isset($add_expense)? ($add_expense->file != ""? getFilePath3($add_expense->file): trans('lang.file')) :  trans('lang.file')}}"readonly
                                                        >
                                                    <span class="focus-border"></span>
                                                    @if ($errors->has('file'))
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{route('add-expense-edit', [@$add_expense->id])}}">@lang('lang.edit') </a>
                                                @endif
