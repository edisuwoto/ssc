...
@section('title') 
@lang('lang.fund') @lang('lang.transfer')
@endsection
@section('mainContent')
@push('css')
<style>
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.fund') @lang('lang.transfer')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.accounts')</a>
                <a href="#">@lang('lang.fund') @lang('lang.transfer')</a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                                <div class="col-lg-4">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h3 class="mb-10">@lang('lang.add') @lang('lang.information')</h3>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0">@lang('lang.amount') @lang('lang.transfer') @lang('lang.list')</h3>
                            </div>
                        </div>
                    </div>                
                    <!-- </div> -->
