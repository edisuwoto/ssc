                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.account') @lang('lang.number') <span>*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.account') @lang('lang.type')</label>
                                            <span class="focus-border"></span>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>@lang('lang.current') @lang('lang.balance')</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{generalSetting()->currency_symbol}}{{@$bank_account->opening_balance}}</td>
                                    <td>{{generalSetting()->currency_symbol}}{{@$bank_account->current_balance}}</td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               <!-- @if(userPermission(158))
                                                <a class="dropdown-item" href="{{route('bank-account-edit', [$bank_account->id])}}">@lang('lang.edit')</a>
                                                @endif -->
                                                @if(userPermission(158))
                                                    <a class="dropdown-item" href="{{route('bank-transaction',[$bank_account->id])}}">@lang('lang.transaction')</a>
                                                @endif
