                ...
                <tr>
                    <th >
                      <div class="numbered_table_row" style="justify-content:center" >
                          <h3>
                            @lang('lang.payslip') @lang('lang.for_the_period_of') {{$payrollDetail->payroll_month}} {{$payrollDetail->payroll_year}}
                          </h3>
                      </div>
                    </th>
                </tr>
            ...
            <tr>
              <td class="border-0 full_name_header">
                  <h4 class="muted_text font_14">
                      @lang('lang.payslip') #@if(isset($payrollDetail)){{$payrollDetail->id}} @endif
                  </h4>
              </td>
              ...
              <td class="border-0 full_name_header">
                    <h4 class="muted_text font_14">
                    @lang('lang.payment') @lang('lang.date'): @if(isset($payrollDetail))
                ...
                <tr>
                    ...
                    <th> @if(isset($payrollDetail)){{$payrollDetail->staffs->staff_no}} @endif</th>
