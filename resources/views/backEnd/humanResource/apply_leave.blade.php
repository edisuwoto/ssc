...
<div class="container-fluid p-0">
                    ...
                    <table class="display school-table school-table-style" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('lang.leave_taken')</th>
                                <th>@lang('lang.leave_days')</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            // $approved_leaves = App\SmLeaveRequest::approvedLeave($my_leave->id);
                                $remaining_days = $my_leave->days - $my_leave->remainingDays;
                            @endphp
                            <tr>
                                <td>{{$my_leave->leaveType !=""?$my_leave->leaveType->type:""}}</td>
                                <td>{{$remaining_days >= 0? $remaining_days:0}}</td>
                                <td>{{$remaining_days < 0? $my_leave->remainingDays - $my_leave->days:0}}</td>
                                <td>{{$my_leave->remainingDays}}</td>
                                <td>{{$my_leave->days}}</td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    @if(userPermission(553) || Auth::user()->role_id == 2 )
                        ...
                        <div class="row no-gutters input-right-icon mt-25">
                            <div class="col">
                                <div class="input-effect">
                                    ...
                                    placeholder="{{isset($apply_leave->file) && $apply_leave->file != ""? getFilePath3($apply_leave->file):trans('lang.file')}}"
                ...
                <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <button class="primary-btn small bg-warning text-white border-0  tr-bg">@lang('lang.pending')</button>@endif
                            ...
                            <button class="primary-btn small bg-danger text-white border-0  tr-bg">@lang('lang.cancelled')</button>
                            @endif
                            </td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        @if(userPermission(194) )

                                        <a data-modal-size="modal-lg" title="View Leave Details" class="dropdown-item modalLink" href="{{route('view-leave-details-apply', $apply_leave->id)}}">@lang('lang.view')</a>

                                        @endif
                                        @if($apply_leave->approve_status == 'P')
                                        @if(userPermission(396))

                                        <a class="dropdown-item" href="{{route('apply-leave-edit', [$apply_leave->id
                                            ])}}">edit</a> 

                                        @endif
                                        @if(userPermission(195))
