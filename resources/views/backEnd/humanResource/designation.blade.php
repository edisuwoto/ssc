            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($designation))
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => array('designation-update',$designation->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                        @else
                          @if(userPermission(181) )
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'designation',
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               @if(userPermission(182))

                                               <a class="dropdown-item" href="{{route('designation-edit', [$designation->id
                                                    ])}}">@lang('lang.edit')</a>
                                               @endif
                                               @if(userPermission(183))
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('lang.cancel')</button>
                                                     {{ Form::open(['route' => array('designation-delete',$designation->id), 'method' => 'DELETE', 'enctype' => 'multipart/form-data']) }}
