...
@section('title')
@lang('lang.staff_attendance_report')
@endsection 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <select class="w-100 niceSelect bb form-control {{ $errors->has('role') ? ' is-invalid' : '' }}"
                                    ...
                                    <option data-display="@lang('lang.select_role')*" value="">@lang('lang.select_role')
                                        *
                                    </option>
                            ...
                            <div class="col-lg-4">
                                <select class="niceSelect w-100 bb form-control {{$errors->has('year') ? 'is-invalid' : ''}}"
                                        name="year" id="year">
                                    <option data-display="@lang('lang.select_year') *"
                                            value="">@lang('lang.select_year') *
                                    </option>
                                    @php
                                        $current_year = date('Y');
                                        $ini = date('y');
