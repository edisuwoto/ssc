...
@section('title')
@lang('lang.update') @lang('lang.course') @lang('lang.details') @lang('lang.heading') @lang('lang.section')
@endsection
@section('mainContent')
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('lang.course') @lang('lang.details') @lang('lang.heading')</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                    <a href="#">@lang('lang.front_settings')</a>
                    <a href="#"> @lang('lang.course') @lang('lang.details') @lang('lang.heading')</a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h3 class="mb-30">
                                    @lang('lang.update') @lang('lang.course') @lang('lang.details') @lang('lang.heading')
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" id="placeholderInput" type="text"
                                                       placeholder="{{isset($update)? ($SmCoursePage->image !="") ? getFilePath3($SmCoursePage->image) :trans('lang.image') .' *' :trans('lang.image') .' *' }}"
                                                       readonly>
                                                <span class="focus-border"></span>
                                                @if($errors->has('image'))
