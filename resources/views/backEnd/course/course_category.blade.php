    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('lang.course') @lang('lang.category')</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                    <a href="#">@lang('lang.front') @lang('lang.settings')</a>
                    <a href="#">@lang('lang.course') @lang('lang.category')</a>
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input
                                                        ...
                                                        placeholder="{{isset($editData->category_image) && @$editData->category_image != ""? getFilePath3(@$editData->category_image):trans('lang.image')}} *"
                                        ...
                                        <div class="text-center mt-10">
                                            <code>@lang('lang.min') (1420*450 px)</code>
                                        </div>
                                    @php
                                        $tooltip = "";
                                        if(userPermission(674)){
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"> @lang('lang.course') @lang('lang.category') @lang('lang.list')</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        @if(userPermission(675))
                                                            <a class="dropdown-item" href="{{route('edit-course-category',$value->id)}}"> @lang('lang.edit')</a>
                                                        @endif
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">
                                                            @lang('lang.delete') @lang('lang.course') @lang('lang.category')
                                                        </h4>
