                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }} mb-30" name="category_id">
                                                <option data-display="@lang('lang.course') @lang('lang.category')*" value="">@lang('lang.select') *</option>
                                                ...
                                                <div class="col">
                                                    <div class="input-effect">
                                                        <input class="primary-input form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" type="text"
                                                                ...
                                                                placeholder="{{isset($add_course)? ($add_course->image !="") ? getFilePath3($add_course->image) :trans('lang.image') .' *' :trans('lang.image') . '(' .trans('lang.min')." 1420*450 PX)" }}"
                                                                readonly
                                                        >
                                                        <span class="focus-border"></span>
                                                        @if ($errors->has('image'))
                                ...
                                <div class="col-md-12 ">
                                    <div class="row mt-20">
                                        <div class="col-md-12 mt-20">
                                            <div class="input-effect">
                                                <label>@lang('lang.overview') </label>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12 text-center">
                            @if(Illuminate\Support\Facades\Config::get('app.app_sync'))
                                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> <button class="primary-btn fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >@lang('lang.update') @lang('lang.course')</button></span>
                                @else
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    @if(userPermission(512))
                                                        ...
                                                        href="{{route('edit-course',$value->id)}}">@lang('lang.edit')</a>
                                                    @endif
