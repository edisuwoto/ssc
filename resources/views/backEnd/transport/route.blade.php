         ...
         <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'transport-route',
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('far') ? ' is-invalid' : '' }}"
                                                type="number" step="0.1" name="far" autocomplete="off" value="{{isset($route)? @$route->far:old('far')}}">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               ...
                                               @if(userPermission(351))
                                                <a class="dropdown-item" href="{{route('transport-route-edit', [@$route->id])}}"> @lang('lang.edit')</a>
                                               @endif
