        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <ul class="nav nav-tabs tab_column" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link @if (Session::get('twilio_settings') != 'active' && Session::get('msg91_settings') != 'active' && Session::get('textlocal_settings') != 'active' && Session::get('HimalayaSms') != 'active' && Session::get('africatalking_settings') != 'active') active @endif" href="#select_sms_service" role="tab" data-toggle="tab">@lang('lang.select_a_SMS_service')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if (Session::get('twilio_settings') == 'active') active @endif " href="#twilio_settings" role="tab" data-toggle="tab">@lang('lang.twilio') </a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link @if (Session::get('msg91_settings') == 'active') active @endif " href="#msg91_settings" role="tab" data-toggle="tab">@lang('lang.msg91') </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if (Session::get('textlocal_settings') == 'active') active @endif " href="#textlocal_settings" role="tab" data-toggle="tab">@lang('lang.textlocal') </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if (Session::get('africatalking_settings') == 'active') active @endif " href="#africatalking_settings" role="tab" data-toggle="tab">@lang('lang.africatalking') </a>
                    </li>  
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (Session::get('Mobile_SMS') == 'active') active @endif " href="#Mobile_SMS" role="tab" data-toggle="tab">@lang('lang.mobile') @lang('lang.sms')</a>
                    </li> 
                </ul>
                <!-- Tab panes -->
                    ...
                    <div class="row mb-30">
                        ...
                        @if($sms_services['Mobile SMS']->device_info)
                            ...
                            <li>
                                ...
                                @else
                                    <button class="primary-btn small bg-success text-white border-0  tr-bg">@lang('lang.online')</button>
                                @endif
                            </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label>@lang('lang.api') @lang('lang.key') <span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-effect">
                                                ...
                                                <label>@lang('lang.route') @lang('lang.id')<span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-lg-6 mb-30">
                                                <div class="input-effect">
                                                    ...
                                                    <label>Campaign  @lang('lang.id')<span>*</span> </label>
                                                    <span class="focus-border"></span>
