    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('sms-settings')}}">@lang('lang.backup_settings')</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
                                ...
                                <div class="row no-gutters input-right-icon mb-20">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            placeholder="{{isset($editData->file) && @$editData->file != ""? getFilePath3(@$editData->file): trans('lang.attach_file') . "*"}} "  id="placeholderUploadContent" name="content_file">
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip" title="@lang('lang.disabled') @lang('lang.image') @lang('lang.backup')">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" > @lang('lang.upload') @lang('lang.file') @lang('lang.backup')</button>
                    </span>
                       
                          <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip" title="@lang('lang.disabled') @lang('lang.database') @lang('lang.backup')">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" >@lang('lang.database') @lang('lang.backup')</button>
                          </span>
                    @else
                        @if(userPermission(460))
                            <a href="{{route('get-backup-files',1)}}" class="primary-btn small fix-gr-bg  demo_view">
                                ...
                                @lang('lang.upload') @lang('lang.file') @lang('lang.backup')
                            </a>
                        @endif 
                        
                        @if(userPermission(462))
                             <a href="{{route('get-backup-db')}}" class="primary-btn small fix-gr-bg demo_view"> <span class="ti-arrow-circle-down pr-2"></span> @lang('lang.database') @lang('lang.backup') </a>
                        @endif 
                @endif 
