                                    ...
                                    <div class="row no-gutters input-right-icon mb-20">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control {{ $errors->has('content_file') ? ' is-invalid' : '' }}"
                                                       readonly="true" type="text"
                                                       placeholder="{{isset($editData->file) && @$editData->file != ""? getFilePath3(@$editData->file): trans('lang.attach_file') . "*"}} "
                        ...
                        <div class="col-lg-8 col-xl-9 text-right col-md-12 mb-20  md_mb_20 title_custom_margin">
                            ...
                            @if(Illuminate\Support\Facades\Config::get('app.app_sync'))
                                <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip"
                                      title="@lang('lang.disabled') @lang('lang.image') @lang('lang.backup')">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;"
                                    type="button"> @lang('lang.upload') @lang('lang.file') @lang('lang.backup')</button>
                    </span>

                                <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip"
                                      title="@lang('lang.disabled') @lang('lang.database') @lang('lang.backup')">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;"
                                    type="button">@lang('lang.database') @lang('lang.backup')</button>
                          </span>
                            @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(userPermission(459))
                                                <a data-target="#deleteDatabase{{@$sms_db->id}}" data-toggle="modal"
                                                   class="primary-btn small tr-bg  " href="{{url('/'.@$sms_db->id)}}">
