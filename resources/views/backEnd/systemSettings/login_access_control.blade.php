                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-3">@lang('lang.student_list') ({{@$students->count()}})</h3>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr id="{{@$student->user_id}}">
                                        ...
                                        <td>
                                            ...
                                            <label class="switch">
                                                @if(Illuminate\Support\Facades\Config::get('app.app_sync'))
                                                    <input type="checkbox" disabled class="parent-login-disable" {{@$parent->parent_user->access_status == 0? '':'checked'}}>
                                                     <span class="slider round" data-toggle="tooltip" title="Disabled For Demo"></span>
                                                    @else 
