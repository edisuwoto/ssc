    ...
    <div class="container-fluid p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 text-center">
                                        <button type="submit" class="primary-btn fix-gr-bg submit result_setup" data-toggle="tooltip" title="{{@$tooltip}}">
                                            ...
                                            @else
                                                <span class="ti-check"></span>@lang('lang.store')
                                            @endif
                                        </button>
                                    </div>
                                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="main-title">
                    <h3 class="mb-30">
                        @lang('lang.merit_list') @lang('lang.contribution') @lang('lang.using')
                    </h3>
                </div>
                <div class="white-box">
                    <div class="d-flex radio-btn-flex">
                        <div class="mr-30">
                            ...
                            <label for="totalMark">@lang('lang.total_mark')</label>
                        </div>
                        <div class="mr-30">
                            ...
                            <label for="grade">@lang('lang.total') @lang('lang.grade')</label>
                        </div>
                    </div>
                </div>
            </div>
