...
@section('title')
@lang('lang.payment_method_settings')
@endsection 
@section('mainContent')
@push('css')
<style>
                            ...
                            <div role="tabpanel" class="tab-pane fade   @if(@$row->gateway_name=='PayPal') active show @endif " id="{{@$row->gateway_name}}">
                                ...
                                @endif   
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 no-gutters">
                                                            <div class="main-title">
                                                                <h3 class="mb-0">@lang('lang.bank') @lang('lang.account') @lang('lang.list')</h3>
                                                                <strong>@lang('lang.note'): </strong><small>@lang('lang.Available') @lang('lang.for') @lang('lang.students') @lang('lang.and') @lang('lang.parents')</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                            ...
                                                            <table id="noSearch" class="display school-table shadow-none" cellspacing="0" width="100%">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>@lang('lang.bank') @lang('lang.name')</th>
                                                                        <th>@lang('lang.account_name')</th>
                                                                        <th>@lang('lang.account') @lang('lang.number')</th>
                                                                        <th>@lang('lang.account') @lang('lang.type')</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                    ...
                                    @if(@$row->gateway_name!="Bank")
                                                ...
                                                <strong class="main-title"> N.B: Please Set This url  <a class="disabled" href="{{ route('handleGatewayCallback')}}" disable>{{ route('handleGatewayCallback')}}</a>  As Paystack Callback Url </strong>  
                                                @endif      
                                            <div class="row mt-40">
                                                <div class="col-lg-12 text-center">
                                                    @if(Illuminate\Support\Facades\Config::get('app.app_sync'))
