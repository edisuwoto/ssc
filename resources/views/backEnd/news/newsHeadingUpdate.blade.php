...
@section('title')
@lang('lang.news_heading')
@endsection
@section('mainContent')
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>@lang('lang.news_heading')</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                    <a href="#">@lang('lang.front_settings')</a>
                    <a href="#">@lang('lang.news_heading')</a>
                </div>
            </div>
        </div>
    </section>
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" id="placeholderInput" type="text"
                                                       placeholder="{{isset($update)? ($SmNewsPage->image !="") ? getFilePath3($SmNewsPage->image) :trans('lang.image') .' *' :trans('lang.image') .' *' }}"
                                                       readonly>
                                                <span class="focus-border"></span>
                                                @if($errors->has('image'))
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control{{ $errors->has('main_image') ? ' is-invalid' : '' }}" id="placeholderIn" type="text"
                                                       placeholder="{{isset($update)? ($SmNewsPage->main_image !="") ? getFilePath3($SmNewsPage->main_image) :trans('lang.main') .' '. trans('lang.image') .' *' :trans('lang.main') .' '. trans('lang.image') .' *' }}"
                                                       readonly>
                                                <span class="focus-border"></span>
