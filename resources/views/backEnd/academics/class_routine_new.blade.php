...
@section('title') 
@lang('lang.class_routine_create')
@endsection
@section('mainContent')
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <div class="white-box">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'class_routine_new', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                        <div class="row">
                                                    ...
                                                    @if(@$assinged_class_routine == "")
                                                        ...
                                                        @if(userPermission(247))
                                                            ...
                                                            <div class="col-lg-6 text-right">
                                                                <a href="{{route('add-new-routine', [$class_time->id, $sm_weekend->id, $class_id, $section_id])}}" class="primary-btn small tr-bg icon-only mr-10 modalLink" data-modal-size="modal-md" title="@lang('lang.create_class_routine')">
