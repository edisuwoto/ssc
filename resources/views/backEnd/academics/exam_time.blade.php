...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.exam_time')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.examination')</a>
                <a href="#">@lang('lang.exam_time')</a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.exam') @lang('lang.period') <span>*</span></label>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('lang.exam_time') @lang('lang.list') </h3>
                        </div>
                    </div>
                </div>
                            ...
                            <thead>
                               @if(session()->has('message-success-delete') != "" ||
                                ...
                                <tr>
                                    ...
                                    <th>@lang('lang.exam') @lang('lang.period')</th>
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="{{route('examTimeEdit',$class_time->id)}}">@lang('lang.edit')</a>
                                                @endif
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">@lang('lang.delete') @lang('lang.exam_time')</h4>
