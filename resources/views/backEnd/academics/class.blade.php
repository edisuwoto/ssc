                                            ...
                                            @foreach($sections as $section)
                                                <div class="">
                                                    @if(isset($sectionId))
                                                        ...
                                                        <label for="section{{@$section->id}}">@lang('lang.section') {{@$section->section_name}}</label>
                                                    @else
                                                        <input type="checkbox" id="section{{@$section->id}}"
                                                               class="common-checkbox form-control{{ @$errors->has('section') ? ' is-invalid' : '' }}"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if(userPermission(263))
                                                        <a class="dropdown-item"
                                                           href="{{route('class_edit', [@$class->id])}}">@lang('lang.edit')</a>
                                                    @endif
                                                    @if(userPermission(264))
                                                        <a class="dropdown-item" data-toggle="modal"
                                                           data-target="#deleteClassModal{{@$class->id}}"
                                                           href="{{route('class_delete', [@$class->id])}}">@lang('lang.delete')</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
