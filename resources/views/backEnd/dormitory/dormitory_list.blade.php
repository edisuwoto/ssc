            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'dormitory-list',
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               @if(userPermission(369))
                                                ...
                                                <a class="dropdown-item" href="{{route('dormitory-list-edit', [$dormitory_list->id])}}">@lang('lang.edit')</a>
                                               @endif
