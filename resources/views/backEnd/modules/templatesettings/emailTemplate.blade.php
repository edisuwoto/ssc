                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <ul class="nav custom_nav flex-column" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" id="password_reset-tab" data-toggle="tab" href="#password_reset" role="tab" aria-controls="password_reset" aria-selected="true"> @lang('lang.password_reset_message') </a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a class="nav-link" id="student_login_credential-tab"  data-toggle="tab" href="#student_login_credential" role="tab" aria-controls="student_login_credential"  aria-selected="false">@lang('lang.student_login_credential_message') </a>
                                    </li>
    
                                    <li class="nav-item">
                                        <a class="nav-link" id="guardian_login_credential_message1-tab"  data-toggle="tab" href="#guardian_login_credential_message1" role="tab" aria-controls="guardian_login_credential_message1" aria-selected="false">@lang('lang.guardian_login_credential_message') </a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" id="staff-tab" data-toggle="tab" href="#staff" role="tab" aria-controls="staff" aria-selected="false">
                                           @lang('lang.staff') @lang('lang.login') @lang('lang.details') 
                                        </a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a class="nav-link" id="student_registration_message1-tab"  data-toggle="tab" href="#student_registration_message1" role="tab" aria-controls="student_registration_message1" aria-selected="false">@lang('lang.student_registration_message')</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link"  id="guardian_registration_message1-tab" data-toggle="tab" href="#guardian_registration_message1" role="tab" aria-controls="guardian_registration_message1" aria-selected="false">@lang('lang.guardian_registration_message')</a>
                                    </li>

                                  
                                    <li class="nav-item">
                                        <a class="nav-link" id="dues_payment_message1-tab"  data-toggle="tab" href="#dues_payment_message1" role="tab" aria-controls="dues_payment_message1" aria-selected="false">@lang('lang.dues_payment_message')</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" id="paymentRejectParent-tab"  data-toggle="tab" href="#paymentRejectParent" role="tab" aria-controls="paymentRejectParent" aria-selected="false">@lang('lang.bank') @lang('lang.reject') @lang('lang.note') @lang('lang.parent')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="paymentRejectStudent-tab"  data-toggle="tab" href="#paymentRejectStudent" role="tab" aria-controls="paymentRejectStudent" aria-selected="false">@lang('lang.bank') @lang('lang.reject') @lang('lang.note') @lang('lang.student')</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" id="footer-tab"  data-toggle="tab" href="#footer" role="tab" aria-controls="footer" aria-selected="false">@lang('lang.email_footer_text') </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade white_box_30px active show" id="password_reset" role="tabpanel" aria-labelledby="password_reset-tab">
                                        <div class="row mt-25">
                                            <div class="col-lg-12 mb-20">
                                                <label> <strong>@lang('lang.varriables') :</strong>  </label>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="input-effect">
                                                    <label>@lang('lang.password_reset_message') </label>
                                    ...
                                    <div class="tab-pane fade white_box_30px" id="paymentRejectParent" role="tabpanel" aria-labelledby="paymentRejectParent-tab">
                                        <div class="row mt-25">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-effect">
                                                    <label>@lang('lang.bank') @lang('lang.reject') @lang('lang.note') @lang('lang.parent') <span></span></label>
                                    ...
                                    <div class="tab-pane fade white_box_30px" id="paymentRejectStudent" role="tabpanel" aria-labelledby="paymentRejectStudent-tab">
                                        <div class="row mt-25">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-effect">
                                                    <label>@lang('lang.bank') @lang('lang.reject') @lang('lang.note') @lang('lang.student') <span></span></label>
