...
<section class="mt-20">
    <div class="container-fluid p-0">
            ...
            <div class="col-lg-6 pull-right">
                <div class="main-title">
                     <div class="print_button pull-right mt-0">
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'parent_exam_schedule_print', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student', 'target' => '_blank']) }}
        ...
        <div class="row">
            <div class="col-lg-12">
                <table id="default_table2" class="display school-table school-table-style" cellspacing="0" width="100%">
                    <thead>
