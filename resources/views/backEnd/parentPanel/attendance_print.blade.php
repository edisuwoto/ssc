        ...
        <tr>
            ...
            <td style="text-aligh:center">
                <p style="font-size:14px !important; border-bottom:1px solid gray" alaign="left"
                   class="text-white">@lang('lang.name'): {{ $student_detail->full_name}} </p>
                <p style="font-size:14px !important; border-bottom:1px solid gray" alaign="left"
                   class="text-white">@lang('lang.month'): {{ date("F", strtotime('00-'.$month.'-01')) }} </p>
                <p style="font-size:14px !important; border-bottom:1px solid gray" alaign="left"
                   class="text-white">@lang('lang.year'): {{ $year }} </p>
