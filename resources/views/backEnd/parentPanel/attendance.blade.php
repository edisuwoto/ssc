...
<section class="student-attendance">
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-12">
                <a href="{{route('my_child_attendance_print',[@$student_detail->id,@$month,@$year])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> @lang('lang.print')</a>
            </div>
        </div>
        <div class="row mt-40">
