                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h4 class="exam_title text-center text-uppercase"> @lang('lang.tabulation_sheet') @lang('lang.of') {{$tabulation_details['exam_term']}} @lang('lang.in') {{$year}}</h4>
                                        <hr>
                                        <br>
                                        <div class="row">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3">
                                                <ul class="student_info info2">
                                                    <li>
                                                        <p>@lang('lang.roll') @lang('lang.no')</p>
                                                        <p class="bold_text">: {{$tabulation_details['student_roll']}}</p>
                                                    </li>
                                                    <li>
                                                        <p>@lang('lang.admission') @lang('lang.no')</p>
                                            ...
                                            <table class="mt-0 mb-20 table table-striped table-bordered scrolled_table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        @endforeach
                                                        <th rowspan="2" class="large_spanTh">@lang('lang.total_mark')</th>
                                                        @if ($optional_subject_setup!='')
                                                            <th class="large_spanTh">@lang('lang.gpa')</th>
                                                            <th rowspan="2" class="large_spanTh">@lang('lang.gpa')</th>
                                                            <th rowspan="2" class="large_spanTh">@lang('lang.result')</th>
                                                        @else
                                                            <th rowspan="2" class="large_spanTh">@lang('lang.gpa')</th>
                                                            <th rowspan="2" class="large_spanTh">@lang('lang.result')</th>
                                                        @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        @endforeach
                                                            <th class="large_padding">@lang('lang.total')</th>
                                                            {{-- <th class="large_padding">@lang('lang.gpa')</th> --}}
                                                        @endforeach
                                                        @if ($optional_subject_setup!='')
                                                            <th class="large_padding"><small>@lang('lang.without_additional')</small></th>
                                                        @endif
                                                    </tr>
                                                </thead>
                                                <tbody>
                            ...
                            <div class="single-report-admit">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-4">
                                            <h3 class="text-white">@lang('lang.class') : {{$tabulation_details['class']}}</h3>
                                            <p class="text-white mb-0">@lang('lang.section') : {{$tabulation_details['section']}}</p>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h4 class="exam_title text-center text-uppercase">
                                                @lang('lang.tabulation_sheet') @lang('lang.of') {{$tabulation_details['exam_term']}} @lang('lang.in') {{$year}}
                                            </h4>
                                            <br>
                                            <div class="row">
                                                ...
                                                <div class="student_marks_table pt-0">
                                                    <div class="table-responsive">
                                                        <table class="mt-30 mb-20 table table-bordered w-100 scrolled_table">
                                                            <thead>
                                                                <tr>
                                                                    <th class="name_field" rowspan="3">@lang('lang.name')</th>
                                                                    <th class="roll_field" rowspan="3">@lang('lang.roll_no')</th>
                                                                    @foreach($subjects as $subject)
                                                                        @php
                                                                            $subject_ID    = $subject->subject_id;
                                                                            $subject_Name   = $subject->subject->subject_name;
                                                                    ...
                                                                    @endforeach
                                                                    <th class="large_spanTh" rowspan="2" colspan="1">@lang('lang.total_mark')</th>
                                                                    @if ($optional_subject_setup!='')
                                                                        <th class="large_spanTh">@lang('lang.gpa')</th>
                                                                        <th rowspan="2" class="large_spanTh">@lang('lang.gpa')</th>
                                                                        <th rowspan="2" class="large_spanTh">@lang('lang.result')</th>
                                                                        {{-- <th class="large_spanTh" rowspan="2" colspan="1"><small>@lang('lang.without_additional')</small></th> --}}
                                                                    @else
                                                                        <th rowspan="2" class="large_spanTh">@lang('lang.gpa')</th>
                                                                        <th rowspan="2" class="large_spanTh">@lang('lang.result')</th>
                                                                    @endif
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @endforeach
                                                                    @if ($optional_subject_setup!='')
                                                                        <th><small>@lang('lang.without_additional')</small></th>
                                                                    @endif
                                                                </tr>
                                                            </thead>
                                                            <tbody>
