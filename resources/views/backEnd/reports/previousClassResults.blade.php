...
@section('title')
@lang('lang.result')  @lang('lang.archive')
@endsection
@section('mainContent')
    <style type="text/css">
        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{route('results-archive')}}">@lang('lang.result')  @lang('lang.archive')  </a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="offset-lg-10 col-lg-2 pull-right text-right mt-20 ">
                        <a target="_blank" href="{{route('session_student_print',$admission_number  )}}"
                           class="primary-btn small fix-gr-bg "><span
                                    class="ti-printer pr-2"></span> @lang('lang.print')  </a>
                    </div>
                </div>
                <div class="row mt-20">
                    <div class="col-lg-12">
                                            ...
                                            <div class="white-box p-5"> 
                                                ...
                                                <div class="row  mt-40 ">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <strong>@lang('lang.date_of_birth'):</strong> {{ $studentDetails->date_of_birth != ""? dateConvert($studentDetails->date_of_birth):''}}
                                                    </div>
                                                </div>
