                ...
                <table style="width:100%">
                    <tr>
                        <td>
                            ...
                            <strong>@lang('lang.school_name'):</strong> {{ generalSetting()->school_name }}
                            <br>
                        </td>
                        <td>
                            <strong>@lang('lang.transcript') @lang('lang.no')
                                :</strong> {{ $studentDetails->admission_number }}<br>
                            <strong>@lang('lang.academic_year'): </strong> {{ generalSetting()->academic_Year->year }}
                            <br>
