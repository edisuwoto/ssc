...
<html lang="en">
<head>
  <title>@lang('lang.progress_card')</title>
  <meta charset="utf-8">
...
<div class="container"> 
        ...
        <h4 style=" text-align: center;  padding: 10px;">@lang('lang.student') @lang('lang.progress') @lang('lang.card')</h4> 
              ...
              <thead>
                ...
                <tr>
                    ...
                    <td colspan="2">{{ $subject->subject_name }} </td>
                     @endforeach
                <td rowspan="{{ $assign_subjects->count()+11}}" > @lang('lang.gpa') </td>
                </tr>
              </thead>
              <tbody>
                <tr>
