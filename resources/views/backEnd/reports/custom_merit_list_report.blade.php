    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-8 pull-right">
                <a href="{{route('custom-merit-list-print', [$InputClassId, $InputSectionId])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> @lang('lang.print')</a>
            </div>
        </div>
                            ...
                            <div class="single-report-admit">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h3 class="primary-color fw-500 text-center">@lang('lang.custom') @lang('lang.merit_list')</h3>
                                        <hr>
                                                        ...
                                                        <table class="w-100 mt-30 mb-20 table table-bordered meritList">
                                                          <thead>
                                                            <tr>
                                                              ...
                                                              <th colspan="" class="full_width" >@lang('lang.admission_no')</th>
