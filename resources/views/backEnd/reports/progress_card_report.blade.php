...
@section('title')
    @lang('lang.progress_card_report')
@endsection
@section('mainContent')
    <style type="text/css">
                    ...
                    <div class="col-lg-8 pull-right mt-0">
                        ...
                        <div class="print_button pull-right">
                            ...
                            <button type="submit" class="primary-btn small fix-gr-bg"><i
                                        class="ti-printer"> </i> @lang('lang.print')
                            </button>
                            {{ Form::close() }}
                        </div>
                    </div>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="col-lg-6 ml-30">
                                                        ...
                                                        <p class="text-white mb-0">
                                                            ...
                                                            , @lang('lang.phone')
                                                            : {{isset(generalSetting()->phone)?generalSetting()->phone:'admin@demo.com'}}
                                                        </p>
                                                    </div>
                                                    <div class="offset-2">
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <p class="mb-0">
                                                                        @lang('lang.section') : &nbsp; &nbsp; &nbsp;
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span
                                                                                class="primary-color fw-500">{{ $studentDetails->section_name }}</span>
                                                                    </p>
                                                                    <p class="mb-0">
                                                                        @lang('lang.class') : &nbsp; &nbsp; &nbsp;
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span
                                                                                class="primary-color fw-500">{{ $studentDetails->class_name }}</span>
                                                                    </p>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <p class="mb-0">
                                                                        @lang('lang.admission') @lang('lang.no') : <span
                                                                                class="primary-color fw-500">{{$studentDetails->admission_no}}</span>
                                                                    </p>
                                                                    <p class="mb-0">
                                                                        @lang('lang.roll') : &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span
                                                                                class="primary-color fw-500">{{$studentDetails->roll_no}}</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <table class="table mb-0">
                                                            ...
                                                            <tr class="text-center">
                                                                @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                                    @if ($student_optional_subject->subject_id==$data->subject->id)
                                                                        <td>{{$data->subject !=""?$data->subject->subject_name:""}}
                                                                            (@lang('lang.optional'))
                                                                        </td>
                                                                    @else
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            @foreach($assinged_exam_types as $assinged_exam_type)
                                                                ...
                                                                @endphp
                                                                <th colspan="4"> @lang('lang.average') @lang('lang.gpa')
                                                                    :
                                                                    {{number_format($term_base_full_mark,2,'.','')}}
                                                                    </br>
                                                                    {{$exam_type->title}} ({{$exam_type->percentage}}%)
                                                        ...
                                                        <tr>
                                                            <td colspan="{{$colspan / $col_for_result - 1}}"
                                                                class="text-center">@lang('lang.total') @lang('lang.marks')</td>
                                                            @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                                <td colspan="{{$colspan / $col_for_result + 7}}"
                                                                    class="text-center"
                                                                    style="padding:10px; font-weight:bold">{{$total_marks}} @lang('lang.out_of') {{$all_exam_type_full_mark}}</td>
                                                            @else
                                                        ...
                                                        <tr>
                                                            <td colspan="{{$colspan / $col_for_result - 1}}"
                                                                class="text-center">@lang('lang.total') @lang('lang.gpa')</td>
                                                            @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                                ...
                                                                <td colspan="3" class="text-center"
                                                                    style="padding:10px;">@lang('lang.without_additional') @lang('lang.grade')</td>
                                                        ...
                                                        <tr>
                                                            <td colspan="{{$colspan / $col_for_result - 1}}"
                                                                class="text-center">@lang('lang.total') @lang('lang.grade')</td>
                                                            @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                                <td colspan="4" class="text-center"
                                                                    style="padding:10px; font-weight:bold">
                                                                ...
                                                                <td colspan="3" class="text-center"
                                                                    style="padding:10px;">@lang('lang.without_additional') @lang('lang.gpa')</td>
                                                                <td colspan="2" class="text-center"
                                                                    style="padding:10px;">
                                                        ...
                                                        <tr>
                                                            @if($optional_subject_setup!='' && $student_optional_subject!='')
                                                                <td colspan="{{$colspan / $col_for_result - 1}}"
                                                                    class="text-center">@lang('lang.remarks')</td>
                                                                <td colspan="{{$colspan / $col_for_result + 7}}"
                                                                    class="text-center"
                                                                    style="padding:10px; font-weight:bold">
