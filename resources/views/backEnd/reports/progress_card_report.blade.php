                                            ...
                                            <div class="card-header">
                                                    <div class="d-flex">
                                                            ...
                                                            <div class="col-lg-6 ml-30">
                                                                ...
                                                                <p class="text-white mb-0">
                                                                    @lang('lang.email'):  {{isset($email)?$email:'admin@demo.com'}} ,   @lang('lang.phone'):  {{isset(generalSetting()->phone)?generalSetting()->phone:'admin@demo.com'}} 
                                                                </p> 
                                                            </div>
                                                            <div class="offset-2">
                                                            </div>
                                                ...
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody class="mark_sheet_body">
                                                        ...
                                                        <tr class="text-center">
                                                            @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                                    @if ($student_optional_subject->subject_id==$data->subject->id)
                                                                        <td>{{$data->subject !=""?$data->subject->subject_name:""}} (@lang('lang.optional'))</td>
                                                                    @else
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                                <td colspan="{{$colspan / $col_for_result + 7}}" class="text-center" style="padding:10px; font-weight:bold">{{$total_marks}} @lang('lang.out_of') {{$all_exam_type_full_mark}}</td>
                                                            @else
                                                                <td colspan="{{$colspan / $col_for_result + 9}}" class="text-center" style="padding:10px; font-weight:bold">{{$total_marks}} @lang('lang.out_of') {{$all_exam_type_full_mark}}</td>
                                                            @endif
                                                        </tr>
                                                        {{-- Total Marks End --}}
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3" class="text-center" style="padding:10px;">@lang('lang.without_additional') @lang('lang.grade')</td>
                                                            <td colspan="2" class="text-center" style="padding:10px;">
                                                                {{number_format($with_percent_average_gpa,2,'.','')}}
                                                            </td>
                                                            @else
                                                                <td colspan="{{$colspan / $col_for_result + 9}}" class="text-center" style="padding:10px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3" class="text-center" style="padding:10px;">@lang('lang.without_additional') @lang('lang.gpa')</td>
                                                            <td colspan="2" class="text-center" style="padding:10px;">
                                                        ...
                                                        <tr>
                                                            @if($optional_subject_setup!='' && $student_optional_subject!='')
                                                                <td colspan="{{$colspan / $col_for_result - 1}}" class="text-center">@lang('lang.remarks')</td>
                                                                <td colspan="{{$colspan / $col_for_result + 7}}" class="text-center" style="padding:10px; font-weight:bold">
