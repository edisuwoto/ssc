                                        ...
                                        <td>
                                            <div class="logo_img">
                                                ...
                                                <div class="company_info">
                                                    ...
                                                    <h5>@lang('lang.email'): {{isset(generalSetting()->email)?generalSetting()->email:'admin@infixedu.com'}} @lang('lang.phone'): {{isset(generalSetting()->phone)?generalSetting()->phone:'+8801841412141 '}}</h5>
                                                </div>
                                            </div>
                                        </td>
                                    </thead>
                            ...
                            <tr>
                                ...
                                <th rowspan="3">@lang('lang.roll_no')</th>
                                    ...
                                    @if ($optional_subject_setup!='')
                                        ...
                                        <th rowspan="2">@lang('lang.result')</th>
                                    @else
                                        <th colspan="1" rowspan="3"> @lang('lang.gpa')</th>
                                    @endif
                            </tr>
                            <tr>
                                @foreach($subjects as $subject)
