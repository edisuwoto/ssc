                        ...
                        <td>
                            <div class="logo_img">
                                ...
                                <div class="company_info">
                                    ...
                                    <h5>@lang('lang.email'): {{isset(generalSetting()->email)?generalSetting()->email:'admin@demo.com'}}, @lang('lang.phone'): {{isset(generalSetting()->phone)?generalSetting()->phone:'+8801841412141'}}</h5>
                                </div>
                            </div>
                        </td>
                        </thead>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <div class="table_title" style="margin-bottom: 20px; text-align: center">
                                <h3>@lang('lang.tabulation_sheet') @lang('lang.of') {{$tabulation_details['exam_term']}} @lang('lang.in') {{$year}}</h3>
                            </div>
                            <table class="mb_30 max-width-500 mr_auto">
                                ...
                                <tr>
                                    <td>
                                        <p class="line_grid" >
                                                                <span>
                                                                    <span>@lang('lang.student') @lang('lang.name')</span><span>:</span>
                                                                </span>
                                    ...
                                    <td>
                                        <p class="line_grid" >
                                                                <span>
                                                                    <span>@lang('lang.class')</span><span>:</span>
                                                                </span>
                                ...
                                <tr>
                                    <td>
                                        <p class="line_grid" >
                                                                <span>
                                                                    <span>@lang('lang.roll') @lang('lang.no')</span><span>:</span>
                                                                </span>
                                    ...
                                    <td>
                                        <p class="line_grid" >
                                                                <span>
                                                                    <span>@lang('lang.section')</span><span>:</span>
                                                                </span>
                                ...
                                <tr>
                                    <td>
                                        <p class="line_grid" >
                                                                <span>
                                                                    <span>@lang('lang.admission') @lang('lang.no')</span><span>:</span>
                                                                </span>
                                    ...
                                    <td>
                                        <p class="line_grid" >
                                                                <span>
                                                                    <span>@lang('lang.exam')</span><span>:</span>
                                                                </span>
...
@elseif (isset($allClass))
    <div class="invoice_wrapper fullwidth_90">
                        ...
                        <td>
                            <div class="logo_img">
                                <div class="logo_thumb_upper">
                                    ...
                                    <h2>
                                        @lang('lang.class') : {{$tabulation_details['class']}}
                                        <br>
                                        <p>@lang('lang.section') : {{$tabulation_details['section']}}</p>
                                    </h2>
                                </div>
                                <div class="company_info">
                                    <h3>{{isset(generalSetting()->school_name)?generalSetting()->school_name:'Infix School Management ERP'}}</h3>
        ...
        <table class="table border_table gray_header_table mb-0" >
            <thead>
            <tr>
                <th rowspan="3">@lang('lang.name')</th>
                <th rowspan="3">@lang('lang.roll_no')</th>
                @foreach($subjects as $subject)
                    @php
                        $subject_ID     = $subject->subject_id;
                        $subject_Name   = $subject->subject->subject_name;
                    ...
                    <th colspan="{{count($mark_parts)+1}}" class="subject-list"> {{$subject_Name}}</th>
                @endforeach
                <th rowspan="2" class="cust_border"> @lang('lang.total_mark')</th>
                @if ($optional_subject_setup!='')
                    <th>@lang('lang.gpa')</th>
                    <th rowspan="2">@lang('lang.gpa')</th>
                    <th rowspan="2">@lang('lang.result')</th>
