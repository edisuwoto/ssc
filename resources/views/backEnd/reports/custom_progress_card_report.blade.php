...
@section('title')
@lang('lang.custom') @lang('lang.progress_card_report')
@endsection
@section('mainContent')
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.custom') @lang('lang.progress_card_report')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.reports')</a>
                <a href="#">@lang('lang.custom') @lang('lang.progress_card_report')</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-lg-8 pull-right mt-0">
                    <div class="print_button pull-right">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'custom-progress-card-print', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student', 'target' => '_blank']) }}
                            ...
                            <button type="submit" class="primary-btn small fix-gr-bg"><i class="ti-printer"> </i> @lamg('lang.print')
                            </button>
                        {{ Form::close() }}
                    </div>
                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row justify-content-between">
                                                <div class="col-lg-7 text-black"> 
                                                    <h3 style="border-bottm:1px solid #ddd; padding: 15px; text-align:center">@lang('lang.student') @lang('lang.information')</h3>
                                                    <h3>{{  $studentDetails->full_name }}</h3>
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <p class="mb-0 d-flex">@lang('lang.academic_year'): 
                                                                <span class="primary-color fw-500">{{generalSetting()->session_year}}</span>
                                                            </p>
                                                            <p class="mb-0 d-flex">@lang('lang.roll') : 
                                                                <span class="primary-color fw-500">{{$studentDetails->roll_no}}</span>
                                                            </p>
                                                            <p class="mb-0"> @lang('lang.admission') @lang('lang.no'):
                                                                <span class="primary-color fw-500"> {{$studentDetails->admission_no}}</span> 
                                                            </p>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <p class="mb-0"> @lang('lang.class') : 
                                                                <span class="primary-color fw-500">{{ $studentDetails->class_name }}</span>
                                                            </p>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <p class="mb-0">@lang('lang.section') : 
                                            ...
                                            <div>
                                            <h3 class="primary-color fw-500 text-center">@lang('lang.progress_card')</h3>
                                            {{-- Start Test --}}
                                            ...
                                            <div class="student_marks_table">
                                                    <table class="custom_table">
                                                      <thead>
                                                        ...
                                                        <th colspan="{{$assign_subjects->count()*2+1}}" class="full_width" >@lang('lang.result')</th>
