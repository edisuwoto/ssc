                            ...
                            <div class="col-lg-12">
                                <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('lang.basic_salary')({{generalSetting()->currency_symbol}})</th>
                                        <th>@lang('lang.earnings')({{generalSetting()->currency_symbol}})</th>
                                        <th>@lang('lang.deductions')({{generalSetting()->currency_symbol}})</th>
                                        <th>@lang('lang.leave') @lang('lang.deductions')({{generalSetting()->currency_symbol}})</th>
                                        <th>@lang('lang.gross_salary')({{generalSetting()->currency_symbol}})</th>
                                        <th>@lang('lang.tax')({{generalSetting()->currency_symbol}})</th>
                                        <th>@lang('lang.net_salary')({{generalSetting()->currency_symbol}})</th>
                                    </tr>
                                    </thead>
