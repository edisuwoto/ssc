...
@section('title')
@lang('lang.exam_routine') @lang('lang.report')
@endsection
@section('mainContent')
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-6 mb-30  col-md-6">
                <a href="{{route('exam-routine/print', [$exam_term_id])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i> @lang('lang.print')</a>
            </div>
        </div>
