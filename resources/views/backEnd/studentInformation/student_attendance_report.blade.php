...
<section class="student-attendance">
    <div class="container-fluid p-0">
        <div class="row mt-40">
            ...
            <div class="col-lg-6 no-gutters">
                <a href="{{route('student-attendance-print', [$class_id, $section_id, $month, $year])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank"><i class="ti-printer"> </i>@lang('lang.print')</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
