                ...
                <div class="{{$custom_field->width}} mt-30">
                    <div class="input-effect sm2_mb_20 md_mb_20">
                        <select class="niceSelect w-100 bb form-control{{ $errors->has($custom_field->label) ? ' is-invalid' : '' }}" 
                            ...
                            <option data-display="{{$custom_field->label}} @lang('lang.select') {{($custom_field->required==1)? "*":""}}" value="">{{$custom_field->label}} @lang('lang.select') {{($custom_field->required==1)? "*":""}}</option>
                    ...
                    <div class="row no-gutters input-right-icon">
                        ...
                        <div class="col-auto">
                            <button class="primary-btn-small-input" type="button">
                                <label class="primary-btn small fix-gr-bg" for="photo_{{$key}}">@lang('lang.browse')</label>
