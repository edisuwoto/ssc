            ...
            <div class="row">
                ...
                <div class="col-lg-9 student-details up_admin_visitor">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="white-box">
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5">
                                            <div class="">
                                                @lang('lang.national_id') @lang('lang.number')
                                            </div>
                                        </div>
                                ...
                                <div class="single-info">
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5">
                                            <div class="">
                                                @lang('lang.local_id') @lang('lang.number')
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <table class="display school-table school-table-style" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="nowrap">@lang('lang.leave_type')</th>
                                                    <th class="nowrap">@lang('lang.leave_from') </th>
                                                    <th class="nowrap">@lang('lang.leave_to')</th>
                                                    <th class="nowrap">@lang('lang.apply_date')</th>
                        ...
                        <div role="tabpanel" class="tab-pane fade {{Session::get('academicHistory') == 'active'? 'show active':''}}" id="academicHistory">
                            <div class="white-box">
                                <div class="text-right mb-20">
                                    <button type="button" data-toggle="modal" data-target="#add_timeline_madal"
                                            class="primary-btn tr-bg text-uppercase bord-rad">
