                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 mt-30-md">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('result') ? ' is-invalid' : '' }}" name="result">
                                        ...
                                        <option value="P">@lang('lang.pass')</option>
                                        <option value="F">@lang('lang.fail')</option>
                                         <option value="Null">@lang('lang.pass') & @lang('lang.fail')</option>
                                    </select>
