...
@section('title')
    @lang('lang.student_attendance_report')
@endsection
@section('mainContent')
@push('css')
    <style>
            ...
            <div class="row mt-40">
                ...
                <div class="col-lg-6 no-gutters mb-30">
                    @if(userPermission(536))
                        <a href="{{route('subject-average-attendance/print', [$class_id, $section_id,$subject_id, $month, $year])}}" class="primary-btn small fix-gr-bg pull-right" target="_blank">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="lateday d-flex flex-wrap">
                        <div class="mr-3 mb-10">@lang('lang.present'): <span class="text-success">P</span></div>
                        <div class="mr-3 mb-10">@lang('lang.late'): <span class="text-warning">L</span></div>
                        <div class="mr-3 mb-10">@lang('lang.absent'): <span class="text-danger">A</span></div>
                        <div class="mr-3 mb-10">@lang('lang.half_day'): <span class="text-info">F</span></div>
