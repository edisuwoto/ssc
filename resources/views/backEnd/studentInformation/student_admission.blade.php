                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input oninput="numberCheck(this)" class="primary-input read-only-input" readonly type="text" id="roll_number" name="roll_number"  value="{{old('roll_number')}}">
                        ...
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    ...
                                    <label>@lang('lang.email') @lang('lang.address')</label>
                                    <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                 ...
                                 <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('lang.father') @lang('lang.phone')</label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                 ...
                                 <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('lang.mother') @lang('lang.phone')</label>
                                        <span class="focus-border"></span>
                            ...
                            <div class="row mb-40">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('lang.guardian') @lang('lang.email')</span>* </label>
                                        <span class="focus-border"></span>
                            ...
                            <div class="row mb-30">
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        ...
                                        <label>@lang('lang.guardian') @lang('lang.phone')</label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                        ...
                        <div class="row mb-30 mt-30">
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    ...
                                    <label>@lang('lang.national_id') @lang('lang.number') <span></span> </label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="main-title">
                                    <h4 class="stu-sub-head">@lang('lang.custom') @lang('lang.field')</h4>
                                </div>
                            </div>
                        </div>
