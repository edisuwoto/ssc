                                ...
                                <div class="col-lg-3">
                                 ...
                                 <div class="col-lg-3">
                                    <div class="input-effect">
                                        ...
                                        <label>@lang('lang.father_phone')</label>
                                        <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                 ...
                                 <div class="col-lg-3">
                                    <div class="input-effect">
                                        ...
                                        <label>@lang('lang.mother_phone')</label>
                                        <span class="focus-border"></span>
                            ...
                            <div class="row mb-20">
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        ...
                                        <label>@lang('lang.guardian_phone')</label>
                                        <span class="focus-border"></span>
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect" id="select_vehicle_div">
                                    <select class="niceSelect w-100 bb form-control{{ $errors->has('vehicle') ? ' is-invalid' : '' }}" name="vehicle" id="selectVehicle">
                                        <option data-display="@lang('lang.vehicle') @lang('lang.number')" value="">@lang('lang.vehicle_number')</option>
