...
@section('title')
@lang('lang.item_store') @lang('lang.list')
@endsection
@section('mainContent')
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    @if(userPermission(326))
                                        <a class="dropdown-item" href="{{route('item-store-edit',@$value->id)}}">@lang('lang.edit')</a>
                                    @endif
                                    @if(userPermission(327))
                                        <a class="deleteUrl dropdown-item" data-modal-size="modal-md" title="Delete Store" href="{{route('delete-store-view',$value->id)}}">@lang('lang.delete')</a>
                                    @endif
                                    </div>
                                </div>
                            </td>
