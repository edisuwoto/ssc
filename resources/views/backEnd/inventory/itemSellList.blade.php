...
@section('title')
@lang('lang.item_sell') @lang('lang.list')
@endsection
@section('mainContent')
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{route('view-item-sell', $value->id)}}">@lang('lang.view')</a>
                                            @php
                                            ...
                                            @endif
                                             ...
                                             <a class="dropdown-item modalLink" title="Add Payment" data-modal-size="modal-md" href="{{route('add-payment-sell', $value->id)}}">@lang('lang.add') @lang('lang.payment')</a>
                                             @endif
                                             @endif
                                             @endif
                                             ...
                                             <a class="dropdown-item modalLink" data-modal-size="modal-lg" title="View Payments" href="{{route('view-sell-payments', $value->id)}}">@lang('lang.view') @lang('lang.payment')</a>
                                              @endif
                                              @endif
                                                ...
                                                <a class="dropdown-item deleteUrl" data-modal-size="modal-md" title="Delete Sold Item" href="{{route('delete-item-sale-view', $value->id)}}">@lang('lang.delete')</a>
                                                @endif
                                                @endif
                                                @endif
                                                ...
                                                <a class="dropdown-item deleteUrl" data-modal-size="modal-md" title="Cancel Item Sell" href="{{route('cancel-item-sell-view', $value->id)}}">@lang('lang.cancel')</a>
                                                @endif
                                                @endif
