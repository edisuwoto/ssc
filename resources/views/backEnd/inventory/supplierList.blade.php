...
@section('title')
@lang('lang.supplier') @lang('lang.list')
@endsection
@section('mainContent')
@push('css')
    <style>
                                   ...
                                   <div class="col-lg-12 mb-30">
                                    ...
                                    <div class="col-lg-12 mb-30">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.contact_person') @lang('lang.mobile')</label>
                                            <span class="focus-border"></span>
                                    ...
                                    <div class="col-lg-12 mb-30">
                                        <div class="input-effect">
                                            ...
                                            <label>@lang('lang.contact_person') @lang('lang.email') <span class="email_info"></span></label>
                                            <span class="focus-border"></span>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        @if(userPermission(330) )
                                            <a class="dropdown-item" href="{{route('suppliers-edit',$value->id)}}"> @lang('lang.edit')</a>
                                        @endif
                                        @if(userPermission(331))
                                            <a class="deleteUrl dropdown-item" data-modal-size="modal-md" title="Delete Supplier" href="{{route('delete-supplier-view',$value->id)}}"> @lang('lang.delete')</a>
                                        @endif
                                        </div>
                                    </div>
                                </td>
