...
@section('title')
@lang('lang.item_category') @lang('lang.list')
@endsection
@section('mainContent')
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    @if(userPermission(318))
                                        <a class="dropdown-item" href="{{route('item-category-edit',$value->id)}}"> @lang('lang.edit')</a>
                                    @endif
                                    @if(userPermission(319))
                                        <a class="deleteUrl dropdown-item" data-modal-size="modal-md" title="Delete Item Category" href="{{route('delete-item-category-view',@$value->id)}}"> @lang('lang.delete')</a>
                                    @endif
                                    </div>
                                </div>
                            </td>
