    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('item-sell')}}">@lang('lang.item_sell')</a>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="add-visitor">
                            ...
                            <div class="col-lg-12 mb-30">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('income_head_id') ? ' is-invalid' : '' }}" name="income_head_id" id="income_head_id">
                                            <option data-display="@lang('lang.income') @lang('lang.head')*" value="">@lang('lang.select') *</option>
                                 ...
                                 <div class="col-lg-12 mb-30">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('role_id') ? ' is-invalid' : '' }}" name="role_id" id="buyer_type">
                                            <option data-display="@lang('lang.sale_to') *" value="">@lang('lang.sale_to') *</option>
        ...
        <div class="col-lg-9">
          ...
          <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-20">@lang('lang.item_sale')</h3>
                </div>
            </div>
                        ...
                        <td class="border-top-0">
                            ...
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('category_name') ? ' is-invalid' : '' }}" name="item_id[]" id="productName1">
                                    <option data-display="@lang('lang.name') @lang('lang.item') " value="">@lang('lang.select')</option>
