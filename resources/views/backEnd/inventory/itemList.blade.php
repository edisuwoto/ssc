                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    @if(userPermission(322))
                                        <a class="dropdown-item" href="{{route('item-list-edit',$value->id)}}">@lang('lang.edit')</a>
                                    @endif
                                    @if(userPermission(323))
                                        <a class="deleteUrl dropdown-item" data-modal-size="modal-md" title="Delete Item" href="{{route('delete-item-view',@$value->id)}}">@lang('lang.delete')</a>
                                    @endif
                                    </div>
                                </div>
                            </td>
