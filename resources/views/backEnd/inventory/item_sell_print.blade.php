...
<html>
<head>
    <title>@lang('lang.sell_receipt')</title>
    <style>
...
<body>
    @php  $setting = App\SmGeneralSettings::find(1);  if(!empty($setting->currency_symbol)){ generalSetting()->currency_symbol = $setting->currency_symbol; }else{ generalSetting()->currency_symbol = '$'; }   @endphp 
                                ...
                                <div class="col-lg-6">
                                    <div class="invoice-details-right">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <p class="fw-500 primary-color">@lang('lang.sell_date'):
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <p class="fw-500 primary-color">@lang('lang.reference') @lang('lang.none'):#{{(isset($viewData)) ? $viewData->reference_no : ''}}</p>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <p class="fw-500 primary-color">@lang('lang.payment') @lang('lang.status'):
