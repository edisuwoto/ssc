...
@section('title')
@lang('lang.item_receive') @lang('lang.list')
@endsection
@section('mainContent')
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{route('view-item-receive', $value->id)}}">@lang('lang.view')</a>
                                            @php
                                            ...
                                            <a class="dropdown-item" href="{{route('edit-item-receive', $value->id)}}">@lang('lang.edit')</a>
                                            @endif
                                            @endif
                                            @endif
                                             ...
                                             <a class="dropdown-item modalLink" title="Add Payment" data-modal-size="modal-md" href="{{route('add-payment',$value->id)}}">@lang('lang.add') @lang('lang.payment')</a>
                                             @endif
                                             @endif

                                             @if($value->paid_status != 'P')
                                                @if(userPermission(337))
                                              <a class="dropdown-item modalLink" data-modal-size="modal-lg" title="View Payments" href="{{route('view-receive-payments', $value->id)}}">@lang('lang.view') @lang('lang.payment')</a>
                                              @endif
                                              @endif
                                                ...
                                                <a class="dropdown-item deleteUrl" data-modal-size="modal-md" title="Delete Item Receive" href="{{route('delete-item-receive-view', $value->id)}}">@lang('lang.delete')</a>
                                                @endif
                                                @endif
                                                @endif
                                                ...
                                                @if($value->paid_status != 'R')
                                                    @if($value->total_paid>0)
                                                        ...
                                                        <a class="dropdown-item deleteUrl" data-modal-size="modal-md" title="Cancel Item Receive" href="{{route('cancel-item-receive-view', $value->id)}}">@lang('lang.cancel')</a>
                                                    @endif
                                                @endif                                           
                                        </div>
                                    </div>
