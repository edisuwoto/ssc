...
@section('title')
@lang('lang.edit') @lang('lang.receive') @lang('lang.details')
@endsection
@section('mainContent')
<style type="text/css">
                                ...
                                <div class="col-lg-12 mb-30">
                                    <div class="input-effect">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('expense_head_id') ? ' is-invalid' : '' }}" name="expense_head_id" id="expense_head_id">
                                            <option data-display="@lang('lang.expense_head') *" value="">@lang('lang.select')</option>
                                    ...
                                    <div class="col-lg-12 mb-30">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control" name="payment_method" id="edit_payment_method">
                                ...
                                <div class="col-lg-12 mb-20">
                                    <div class="input-effect">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('supplier_id') ? ' is-invalid' : '' }}" name="supplier_id" id="supplier_id">
                                            <option data-display="@lang('lang.select') @lang('lang.supplier') *" value="">@lang('lang.select')</option>
                                            @if(isset($suppliers))
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('store_id') ? ' is-invalid' : '' }}" name="store_id" id="store_id">
                                                <option data-display="@lang('lang.select') @lang('lang.store')/@lang('lang.warehouse') *" value="">@lang('lang.select')</option>
                                                @if(isset($itemStores))
                        ...
                        <td>
                            ...
                            <div class="input-effect">
                                <select class="niceSelect w-100 bb form-control{{ $errors->has('item_id') ? ' is-invalid' : '' }}" name="item_id[]" id="productName{{$i}}">
                                    <option data-display="@lang('lang.select') @lang('lang.item') " value="">@lang('lang.select')</option>
