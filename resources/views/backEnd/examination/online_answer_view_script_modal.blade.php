            ...
            <tbody>
                <tr align="center">
                    <td colspan="3">
                        ...
                        <h3><strong>@lang('lang.subjects'): </strong>{{ @$take_online_exam->onlineExam !=""? @$take_online_exam->onlineExam->subject->subject_name:""}}</h3>
                        <h3><strong>@lang('lang.total_marks'): {{@$take_online_exam->total_marks}} </strong></h3>
                        <h3>
