                                ...
                                <div class="row  pl-10">
                                    <div class="col-lg-7 mt-20">
                                        <h3>{{@$take_online_exam->onlineExam !=""?$take_online_exam->onlineExam->question:""}}</h3>
                                                    <h4><strong>@lang('lang.subjects'): </strong>{{@$take_online_exam->onlineExam!=""?@$take_online_exam->onlineExam->subject->subject_name:""}}</h4>
                                                    <h4><strong>@lang('lang.total_marks'): {{@$total_mark}} </strong></h4>
                                                    <h4><strong>@lang('lang.minimum_percentage') : {{@$online_exam_info->percentage}} </strong></h4>
                                                    
                                    <p><strong>@lang('lang.instruction') : </strong>{{@$take_online_exam->onlineExam->instruction}}</p>
                                    </div>
                                    <div class="col-lg-5 mt-20">
                                        {{-- <p class="mb-2"><strong>@lang('lang.exam_has_to_be_submitted_within'): </strong>{{@$take_online_exam->onlineExam !=""?@$take_online_exam->onlineExam->date:""}} {{@$take_online_exam->onlineExam!=""?@$take_online_exam->onlineExam->end_time:""}}</p> --}}
                                        <p class="mb-2">
                                            <strong>@lang('lang.date') & @lang('lang.time'): </strong>{{@$take_online_exam->onlineExam !=""?dateConvert(@$take_online_exam->onlineExam->date):""}} {{@$take_online_exam->onlineExam!=""?dateConvert(@$take_online_exam->onlineExam->end_time):""}}
                                        </p>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right">@lang('lang.incorrect')</th>
                                ...
                                <tr>
                                     ...
                                     @endif
                                        ...
                                        @else
                                            ...
                                            <div class="input-effect mt-20">
                                                <textarea readonly class="primary-input form-control mt-10 has-content" cols="0" rows="5" name="suitable_words_{{@$question->question_bank_id}}">{{@$student_answer->user_answer}}</textarea>
                                        ...
                                        <div class="mt-20">
                                            ...
                                            @endphp
                                            <h4 class="text-center">[@lang('lang.currect_answer'): {{$currect_multiple}}]</h4>
                                            @elseif(@$question->questionBank->type == "MI")
                                            @php
                                                $ques_bank_multiples = $question->questionBank->questionMu;
                                                $currect_multiple = '';
                                                $k = 0;
                                            @endphp
                                        <h4 class="text-center">[@lang('lang.currect_answer')]</h4>
                                        <div class="quiestion_group">
                                        @php
                                            ...
                                            @elseif(@$question->questionBank->type == "T")
                                                <h4 class="text-center">[@lang('lang.currect_answer'): {{@$question->questionBank->trueFalse == "T"? 'True': 'False'}}]</h4>
                                            @else 
                                                <h4 class="text-center">[@lang('lang.currect_answer'): {{@$question->questionBank->suitable_words}}]</h4>
                                            @endif
                                        </div>
                                    </td>
                                    ...
                                    <td width="10%" class="text-right">
                                        <div class="mt-20 float-right">
                                            <input type="radio" id="marks_{{@$question->questionBank!=""?@$question->questionBank->id:""}}_incorrect"  class="common-radio relationButton" name="marks[]{{@$question->questionBank->id}}" {{@$incorrect}} >
                                            <label for="marks_{{@$question->questionBank!=""?@$question->questionBank->id:""}}_incorrect"></label>
                                        </div>
                                    </td>
                                    <td width="10%" class="text-right">
                                        <div class="mt-20">
                                            <input type="radio" id="marks_{{@$question->questionBank !=""?@$question->questionBank->id:""}}" class="common-radio relationButton" name="marks[]{{@$question->questionBank->id}}" value="{{@$question->questionBank!=""?@$question->questionBank->id:""}}" {{@$correct}}>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="text-center">
                                            <div class="alert alert-warning" role="alert">
                                                @lang('lang.exam') @lang('lang.marks')  @lang('lang.already_submitted')
                                              </div>
                                            <a href="{{ url()->previous() }}" class="primary-btn fix-gr-bg">
                                                {{-- <span class="ti-check"></span> --}}
                                                @lang('lang.already_submitted')
                                            </a>
                                        </td>
                                    </tr>
                                @else
