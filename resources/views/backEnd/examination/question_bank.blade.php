                                    ...
                                    <div class="col-lg-12">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('question_type') ? ' is-invalid' : '' }}" name="question_type"  id="question-type">
                                            ...
                                            @if (moduleStatusCheck('MultipleImageQuestion')== TRUE)
                                                <option value="MI" {{isset($bank)? $bank->type == "MI"? 'selected': '' : ''}}>@lang('lang.multiple_image')</option>
                                            @endif
                                    ...
                                    <div class="row mt-25 mb-20">
                                        <div class="col-lg-12">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('answer_type') ? ' is-invalid' : '' }}" id="answer_type" name="answer_type" >
                                                <option data-display="@lang('lang.answer_type') *" value="">@lang('lang.answer_type') *</option>
                                                <option value="radio" {{isset($bank)? $bank->answer_type == "radio"? 'selected': '' : ''}}>@lang('lang.single_select')</option>
                                                <option value="checkbox" {{isset($bank)? $bank->answer_type == "checkbox"? 'selected': '' : ''}}>@lang('lang.multiple_select')</option>
                                            </select>
                                    ...
                                    <div class="row no-gutters input-right-icon mb-20">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input
                                                        ...
                                                        placeholder="{{isset($bank->question_image) && @$bank->question_image != ""? getFilePath3(@$bank->question_image):trans('lang.question_image').' *'}}  [650x450]"
                                        ...
                                        .multiple-images ::-webkit-file-upload-button {
                                            ...
                                            <div class="row  mt-25">
                                                ...
                                                <div class="col-lg-2">
                                                    <button type="button" class="primary-btn small fix-gr-bg" id="create-image-option">@lang('lang.create')</button>
                                                </div>
                                            </div>
