                        ...
                        <div class="col-lg-12">
                            <table id="table_id_table" class="display school-table" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    @endif
                                    <tr>
                                        <th width="20%">@lang('lang.admission') @lang('lang.no')</th>
                                        <th width="20%">@lang('lang.student') @lang('lang.name')</th>
                                        <th width="20%">@lang('lang.class_Sec')</th>
                                        <th width="20%">@lang('lang.roll') @lang('lang.no')</th>
                                        <th width="20%">@lang('lang.attendance')</th>
                                    </tr>
                                </thead>
