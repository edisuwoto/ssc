                                ...
                                <div class="row  pl-10">
                                    <div class="col-lg-7 mt-20">
                                        <h3>{{@$take_online_exam->onlineExam !=""?$take_online_exam->onlineExam->question:""}}</h3>
                                                    ...
                                                    <h4><strong>@lang('lang.total_marks'): {{@$take_online_exam->total_marks}} </strong></h4>
                                                    
                                                    <p><strong>@lang('lang.instruction') : </strong>{{@$take_online_exam->onlineExam->instruction}}</p>
                                    </div>
                                    <div class="col-lg-5 mt-20">
                                        <p class="mb-2"><strong>@lang('lang.date') & @lang('lang.time'): </strong>{{@$take_online_exam->onlineExam !=""?dateConvert(@$take_online_exam->onlineExam->date):""}} {{@$take_online_exam->onlineExam!=""?dateConvert(@$take_online_exam->onlineExam->end_time):""}}</p>
