                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table class="display school-table school-table-style" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            @foreach($exam_schedules as $exam_date)
                                <tr>
                                    <td>{{ @$exam_date->date != ""? dateConvert(@$exam_date->date):''}}</td>
                                    @foreach($exam_periods as $exam_period)
                                        @php
                                           ...
                                           // $assigned_routine = App\SmExamSchedule::assignedRoutine($class_id, $section_id, $exam_id, $assign_subject->subject_id, $exam_period->id);
                                            $assigned_routine = App\SmExamSchedule::examScheduleSubject($class_id, $exam_date->section_id, $exam_id, $exam_period->id, $exam_date->date);
                                        @endphp
                                        ...
                                        <td>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <br>
                                                <span class="">{{$assigned_routine->className->class_name.'('.$assigned_routine->section->section_name.')'}}->{{@$assigned_routine->subject->subject_name}}</span>
                                            </div>
                                            {{-- @endforeach --}}
