        ...
        <div class="student-details">
                                        ...
                                        <tbody>
                                            @foreach($students as $value)
                                                ...
                                                @if($submitted_student != "")
                                                    <tr>
                                                        <td>{{$submitted_student->studentInfo->admission_no}}</td>
                                                        <td>{{$submitted_student->studentInfo->full_name}}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="mr-30">
                                                                    <input type="radio" id="buttonNG{{$submitted_student->studentInfo->id}}" class="common-radio" name="teacher_comments[{{$submitted_student->studentInfo->id}}]" value="NG" {{$submitted_student->teacher_comments == "NG"? 'checked':''}}> &nbsp; &nbsp;<label class="nowrap" for="buttonNG{{$submitted_student->studentInfo->id}}">@lang('lang.not') @lang('lang.good')</label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="mr-30">
                                                                    <input type="radio" id="buttonC{{$submitted_student->studentInfo->id}}" class="common-radio" name="homework_status[{{$submitted_student->studentInfo->id}}]" value="C" {{$submitted_student->complete_status == "C"? 'checked':''}} checked> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<label for="buttonC{{$submitted_student->studentInfo->id}}">@lang('lang.completed')</label> &nbsp; &nbsp;
                                                                </div>
                                                                <div class="mr-30">
                                                                    <input type="radio" id="buttonNC{{$submitted_student->studentInfo->id}}" class="common-radio" name="homework_status[{{$submitted_student->studentInfo->id}}]" value="NC" {{$submitted_student->complete_status == "NC"? 'checked':''}}>&nbsp; &nbsp; <label class="nowrap" for="buttonNC{{$submitted_student->studentInfo->id}}">@lang('lang.not') @lang('lang.completed')</label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="mr-30">
                                                                    <input type="radio" id="buttonNG{{$value->id}}" class="common-radio" class="common-radio" name="teacher_comments[{{$value->id}}]" value="NG" checked> &nbsp; &nbsp;<label class="nowrap" for="buttonNG{{$value->id}}">@lang('lang.not') @lang('lang.good')</label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex">
                                                            <div class="mr-30">
                                                                <input type="radio" id="buttonC{{$value->id}}" class="common-radio" name="homework_status[{{$value->id}}]" value="C"> &nbsp; &nbsp;<label for="buttonC{{$value->id}}">@lang('lang.completed')</label> &nbsp; &nbsp;
                                                            </div>
                                                            <div class="mr-30">
                                                                <input type="radio" id="buttonNC{{$value->id}}" class="common-radio" name="homework_status[{{$value->id}}]" value="NC" checked>&nbsp; &nbsp; <label class="nowrap" for="buttonNC{{$value->id}}">@lang('lang.not') @lang('lang.completed')</label>
                                                            </div>
                                                        </div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">@lang('lang.home_work') @lang('lang.attach_file')</h4>
                                                                    ...
                                                                    @foreach ($file_paths as $file_key=> $std_file)
                                                                        ...
                                                                        @endphp
                                                                            ...
                                                                            <div class="mt-40 d-flex justify-content-between">
                                                                                ...
                                                                                @endphp
                                                                                <a class="primary-btn tr-bg" download="{{$set_filename}}" href="{{asset($attached_file)}}"> <span class="pl ti-download"> @lang('lang.download')</span></a> 
                                                                                {{-- {{route('download-uploaded-content-admin',$uploadedContent->id)}} --}}
                                                                        </div>
                                                                        <hr>
                                                                        @endforeach
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12 text-center">
                                        <button class="primary-btn fix-gr-bg" data-toggle="tooltip" title="">
                                            ...
                                            @lang('lang.save') @lang('lang.evaluation')
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal fade admin-query admin_view_modal" id="viewHomeworkFile" >
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">@lang('lang.home_work') @lang('lang.file')</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
                        <div class="modal-body">
                                @php
