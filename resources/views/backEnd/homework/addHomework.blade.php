                                ...
                                <div class="col-lg-4">
                                    {{-- <div class="input-effect" id="m_select_subject_section_div">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('section_id') ? ' is-invalid' : '' }} m_select_subject_section" name="m_select_subject_section" id="sectionSelectStudent">
                                             ...
                                             <option  value="all_section"> @lang('lang.all') @lang('lang.section')</option>
                                         </select>
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input oninput="numberCheck(this)" class="primary-input form-control{{ $errors->has('marks') ? ' is-invalid' : '' }}"
