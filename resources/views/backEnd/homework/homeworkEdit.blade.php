...
@section('title')
@lang('lang.edit') @lang('lang.home_work')
@endsection
@section('mainContent')
    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('homework-list')}}">@lang('lang.home_work') @lang('lang.list')</a>
...
<section class="admin-visitor-area">
    ...
    <div class="row no-gutters input-right-icon">
        <div class="col">
            <div class="input-effect">
                <input class="primary-input" type="text" id="placeholderHomeworkName" placeholder="{{$homeworkList->file != ""? getFilePath3($homeworkList->file):'File Name'}}" readonly>
                <span class="focus-border"></span>
            </div>
        </div>
        <div class="col-auto">
