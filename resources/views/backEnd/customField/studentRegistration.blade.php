...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('lang.student') @lang('lang.registration')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('lang.dashboard')</a>
                <a href="#">@lang('lang.custom') @lang('lang.field')</a>
                <a href="#">@lang('lang.student') @lang('lang.registration')</a>
            </div>
        </div>
    </div>
</section>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if(userPermission(1103))
                                                        <a class="dropdown-item" href="{{route('edit-custom-field',['id' => @$custom_field->id])}}">@lang('lang.edit')</a>
                                                    @endif
