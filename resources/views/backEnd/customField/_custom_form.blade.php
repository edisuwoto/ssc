<div class="row">
    <div class="col-lg-4">
        <div class="input-effect">
            ...
            <label>@lang('lang.label')<span>*</span></label>
    ...
    <div class="col-lg-4">
        <select class="w-100 bb niceSelect form-control {{ $errors->has('type') ? ' is-invalid' : '' }}" name="type" id="inputType">
            <option data-display="@lang('lang.type') *" value="">@lang('lang.select') @lang('lang.type') *</option>
            <option value="textInput" {{isset($v_custom_field)? ($v_custom_field->type =="textInput" ?'selected':''): (old('type') == 'textInput' ? 'selected' : '') }}>@lang('lang.text') @lang('lang.input')</option>
            <option value="numericInput" {{isset($v_custom_field)? ($v_custom_field->type =="numericInput"?'selected':''): (old('type') == 'numericInput' ? 'selected' : '')}}>@lang('lang.numeric') @lang('lang.input')</option>
            <option value="multilineInput" {{isset($v_custom_field)? ($v_custom_field->type =="multilineInput"?'selected':''): (old('type') == 'multilineInput' ? 'selected' : '')}}>@lang('lang.multiline') @lang('lang.input')</option>
            <option value="datepickerInput" {{isset($v_custom_field)? ($v_custom_field->type =="datepickerInput"?'selected':''): (old('type') == 'datepickerInput' ? 'selected' : '')}}>@lang('lang.datepicker') @lang('lang.input')</option>
            <option value="checkboxInput" {{isset($v_custom_field)? ($v_custom_field->type =="checkboxInput"?'selected':''): (old('type') == 'checkboxInput' ? 'selected' : '')}}>@lang('lang.checkbox') @lang('lang.input')</option>
            <option value="radioInput" {{isset($v_custom_field)? ($v_custom_field->type =="radioInput"?'selected':''): (old('type') == 'radioInput' ? 'selected' : '')}}>@lang('lang.radio') @lang('lang.input')</option>
            <option value="dropdownInput" {{isset($v_custom_field)? ($v_custom_field->type =="dropdownInput"?'selected':''):(old('type') == 'dropdownInput' ? 'selected' : '')}}>@lang('lang.dropdown') @lang('lang.input')</option>
            <option value="fileInput" {{isset($v_custom_field)? ($v_custom_field->type =="fileInput"?'selected':''):(old('type') == 'fileInput' ? 'selected' : '')}}>@lang('lang.file') @lang('lang.input')</option>
        </select>
        @if($errors->has('type'))
    ...
    <div class="col-lg-4">
        <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
            ...
            <label for="labalRequired">@lang('lang.required')</label>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-xl-8">
        <div class="row mt-30 text_input d-none">
            <div class="col-lg-6">
                <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                    ...
                    <label>@lang('lang.min') @lang('lang.length')</label>
                    <span class="focus-border"></span>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                    ...
                    <label>@lang('lang.max') @lang('lang.length')</label>
                    <span class="focus-border"></span>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-30 numeric_input d-none">
            <div class="col-lg-6">
                <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                    ...
                    <label>@lang('lang.min') @lang('lang.value')</label>
                    <span class="focus-border"></span>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="input-effect sm_mb_20 sm2_mb_20 md_mb_20">
                    ...
                    <label>@lang('lang.max') @lang('lang.value')</label>
                    <span class="focus-border"></span>
                </div>
            </div>
        </div>
        ...
        @endphp
        <input type="hidden" value="@lang('lang.value')" id="rowLang" >
        @if (isset($v_custom_field))
                    ...
                    <div class="row mt-30 static d-none">
                        <div class="col-lg-6">
                            <div class="input-effect">
                                ...
                                <label>{{isset($v_custom_field)? $v_name_value: trans('lang.value')}}</label>
                                <span class="focus-border"></span>
                            </div>
                            @if ($errors->has('value'))
                                <span class="invalid-feedback" role="alert">
    ...
    <div class="col-xl-4 mt-30">
        <select class="w-100 bb niceSelect form-control {{ $errors->has('width') ? ' is-invalid' : '' }}" name="width">
            <option data-display="@lang('lang.width') *" value="">@lang('lang.select') @lang('lang.width') *</option>
            <option value="col-12" {{isset($v_custom_field)? ($v_custom_field->width =="col-12"?'selected':''):(old('width') == 'col-12' ? 'selected' : '')}}>@lang('lang.full') @lang('lang.width')</option>
            <option value="col-6" {{isset($v_custom_field)? ($v_custom_field->width =="col-6"?'selected':''):(old('width') == 'col-6' ? 'selected' : '')}}>@lang('lang.half') @lang('lang.width')</option>
            <option value="col-3" {{isset($v_custom_field)? ($v_custom_field->width =="col-3"?'selected':''):(old('width') == 'col-3' ? 'selected' : '')}}>@lang('lang.one_thired') @lang('lang.width')</option>
            <option value="col-4" {{isset($v_custom_field)? ($v_custom_field->width =="col-4"?'selected':''):(old('width') == 'col-4' ? 'selected' : '')}}>@lang('lang.one_fourth') @lang('lang.width')</option>
        </select>
        @if($errors->has('width'))
            <span class="invalid-feedback invalid-select" role="alert">
...
@if(userPermission(1102) || userPermission(1106))
    <div class="col-lg-12 mt-20 text-right">
        <button type="submit" class="primary-btn small fix-gr-bg">
            ...
            {{isset($v_custom_field)?trans('lang.update'):trans('lang.save')}}
        </button>
    </div>
@endif
