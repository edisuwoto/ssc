                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        @lang('lang.password_reset_message') 
                                    </td>
                                </tr>
                                <tr>
                                    <td height="50"><img
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" border="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:14px 30px 14px 30px;text-transform:uppercase; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align:center; font-size: 14px; font-weight:bold; line-height: 1.3; color:#ffffff;">
                                                                            <a href="{{url('reset/password'.'/'.$data['email'].'/'.$data['random'])}}"
                                                                               style="color:#ffffff; text-decoration:none;"
                                                                               target="_blank"> @lang('lang.click_here')</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        $body = @$email_template->password_reset_message;
