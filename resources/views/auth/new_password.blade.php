...
<head>
    ...
    <title>@lang('lang.reset') @lang('lang.password') </title>
			...
			<div class="row login-height justify-content-center align-items-center">
				<div class="col-lg-5 col-md-8">
					<div class="form-wrap text-center">
						...
						<h5 class="text-uppercase">@lang('lang.reset') @lang('lang.password')</h5>
                        ...
                        @csrf
							...
							<div class="form-group input-group mb-4 mx-3">
								...
								<input class="form-control{{ $errors->has('new_password') ? ' is-invalid' : '' }}" type="password" name='new_password' placeholder="@lang('lang.enter') @lang('lang.new') @lang('lang.password')"/>
							...
							<div class="form-group input-group mb-4 mx-3">
								...
								<input class="form-control{{ $errors->has('confirm_password') ? ' is-invalid' : '' }}" type="password" name='confirm_password' placeholder="@lang('lang.confirm') @lang('lang.new') @lang('lang.password')"/>
