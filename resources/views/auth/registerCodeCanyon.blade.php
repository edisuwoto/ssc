                    ...
                    <div class="in_login_content">
                        ...
                        <div class="in_login_page_iner">
                            <div class="in_login_page_header">
                                <h5>{{__('Registration')}} @lang('lang.details')</h5>
                            </div>
                            ...
                            {{-- @endif --}}
                                ...
                                <div class="in_single_input">
                                    <input type="text" placeholder="@lang('lang.enter') @lang('lang.name')" name="fullname" class="{{ $errors->has('fullname') ? ' is-invalid' : '' }}" value="{{old('fullname')}}" id="fullname">
                                ...
                                <div class="in_single_input">
                                    <input type="password" placeholder="@lang('lang.enter')  @lang('lang.confirm')  @lang('lang.password')" name="password_confirmation"
