                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <ul class="nav custom_nav flex-column" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" id="password_reset-tab" data-toggle="tab" href="#password_reset" role="tab" aria-controls="password_reset" aria-selected="true"> @lang('lang.password') @lang('lang.reset') </a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a class="nav-link" id="student_login_credential-tab"  data-toggle="tab" href="#student_login_credential" role="tab" aria-controls="student_login_credential"  aria-selected="false">@lang('lang.student') @lang('lang.login')  </a>
                                    </li>
    
                                    <li class="nav-item">
                                        <a class="nav-link" id="guardian_login_credential_message1-tab"  data-toggle="tab" href="#guardian_login_credential_message1" role="tab" aria-controls="guardian_login_credential_message1" aria-selected="false">@lang('lang.guardian') @lang('lang.login')</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" id="staff-tab" data-toggle="tab" href="#staff" role="tab" aria-controls="staff" aria-selected="false">
                                           @lang('lang.staff') @lang('lang.login')  
                                        </a>
                                    </li>
                                    @if(moduleStatusCheck('ParentRegistration'))
                                    <li class="nav-item">
                                        <a class="nav-link" id="student_registration_message1-tab"  data-toggle="tab" href="#student_registration_message1" role="tab" aria-controls="student_registration_message1" aria-selected="false">@lang('lang.online') @lang('lang.student') @lang('lang.registration')</a>
                                    </li>

                                    {{-- <li class="nav-item">
                                        <a class="nav-link"  id="guardian_registration_message1-tab" data-toggle="tab" href="#guardian_registration_message1" role="tab" aria-controls="guardian_registration_message1" aria-selected="false">@lang('lang.guardian') @lang('lang.registration')</a>
                                    </li> --}}
                                    @endif
                                  
                                    <li class="nav-item">
                                        <a class="nav-link" id="dues_payment_message1-tab"  data-toggle="tab" href="#dues_payment_message1" role="tab" aria-controls="dues_payment_message1" aria-selected="false">@lang('lang.due') @lang('lang.payment')</a>
                                    </li>
